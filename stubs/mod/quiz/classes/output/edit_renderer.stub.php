...
class edit_renderer extends \plugin_renderer_base
{
     ...
     */
    public function edit_page(\quiz $quizobj, structure $structure, \question_edit_contexts $contexts, \moodle_url $pageurl, array $pagevars)
    {
    }
    /**
     ...
     */
    protected function new_page_template(structure $structure, \question_edit_contexts $contexts, array $pagevars, \moodle_url $pageurl)
    {
    }
    /**
     * HTML for a page, with ids stripped, so it can be used as a javascript template.
