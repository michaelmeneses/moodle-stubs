...
class posts extends exporter
{
     ...
     */
    public function __construct(array $posts, array $authorsbyid = [], array $authorcontextids = [], array $attachmentsbypostid = [], array $groupsbyauthorid = [], array $tagsbypostid = [], array $ratingbypostid = [], array $related = [])
    {
    }
    /**
