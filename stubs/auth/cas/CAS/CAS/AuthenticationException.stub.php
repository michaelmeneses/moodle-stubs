...
/**
 * Auto-generated stub file for Moodle's auth/cas/CAS/CAS/AuthenticationException.php
 *
...
class CAS_AuthenticationException extends RuntimeException implements CAS_Exception
{
     ...
     */
    public function __construct($client, $failure, $cas_url, $no_response, $bad_response = false, $cas_response = '', $err_code = -1, $err_msg = '')
    {
    }
}