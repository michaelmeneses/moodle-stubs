...
class provider implements \core_privacy\local\metadata\provider, \core_privacy\local\request\subsystem\plugin_provider
{
     ...
     */
    public static function export_comments(\context $context, $component, $commentarea, $itemid, $subcontext, $onlyforthisuser = true)
    {
    }
    /**
     ...
     */
    public static function delete_comments_for_all_users_select(\context $context, $component, $commentarea, $itemidstest, $params = [])
    {
    }
    /**
     ...
     */
    public static function delete_comments_for_user(\core_privacy\local\request\approved_contextlist $contextlist, $component, $commentarea = null, $itemid = null)
    {
    }
}