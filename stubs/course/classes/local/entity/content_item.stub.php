...
/**
 * Auto-generated stub file for Moodle's course/classes/local/entity/content_item.php
 *
...
class content_item
{
     ...
     */
    public function __construct(int $id, string $name, title $title, \moodle_url $link, string $icon, string $help, int $archetype, string $componentname, string $purpose, bool $branded = false)
    {
    }
    /**
