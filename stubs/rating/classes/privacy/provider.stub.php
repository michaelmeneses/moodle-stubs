...
class provider implements \core_privacy\local\metadata\provider, \core_privacy\local\request\subsystem\plugin_provider
{
     ...
     */
    public static function export_area_ratings($userid, \context $context, array $subcontext, $component, $ratingarea, $itemid, $onlyuser = true)
    {
    }
    /**
     ...
     */
    public static function delete_ratings(\context $context, $component = null, $ratingarea = null, $itemid = null)
    {
    }
    /**
     ...
     */
    public static function delete_ratings_select(\context $context, $component, $ratingarea, $itemidstest, $params = [])
    {
    }
}