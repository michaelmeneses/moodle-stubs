...
class api
{
     ...
     */
    public static function get_events($timestartfrom = null, $timestartto = null, $timesortfrom = null, $timesortto = null, $timestartaftereventid = null, $timesortaftereventid = null, $limitnum = 20, $type = null, array $usersfilter = null, array $groupsfilter = null, array $coursesfilter = null, $withduration = true, $ignorehidden = true)
    {
    }
    /**
     ...
     */
    public static function get_action_events_by_timesort($timesortfrom = null, $timesortto = null, $aftereventid = null, $limitnum = 20)
    {
    }
    /**
     * Get a list of action events for the logged in user by the given
     ...
     */
    public static function get_action_events_by_course($course, $timesortfrom = null, $timesortto = null, $aftereventid = null, $limitnum = 20)
    {
    }
    /**
     * Get a list of action events for the logged in user by the given
     ...
     */
    public static function get_action_events_by_courses($courses = [], $timesortfrom = null, $timesortto = null, $limitnum = 20)
    {
    }
}