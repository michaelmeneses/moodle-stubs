...
/**
 * Auto-generated stub file for Moodle's calendar/classes/local/event/data_access/event_vault_interface.php
 *
...
interface event_vault_interface
{
     ...
     */
    public function get_action_events_by_timesort(\stdClass $user, $timesortfrom, $timesortto, event_interface $afterevent, $limitnum, $limittononsuspendedevents);
    /**
     ...
     */
    public function get_action_events_by_course(\stdClass $user, \stdClass $course, $timesortfrom, $timesortto, event_interface $afterevent, $limitnum);
}