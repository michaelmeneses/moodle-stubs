...
/**
 * Auto-generated stub file for Moodle's calendar/classes/local/event/entities/event.php
 *
...
class event implements event_interface
{
     ...
     */
    public function __construct($id, $name, description_interface $description, proxy_interface $course = null, proxy_interface $group = null, proxy_interface $user = null, event_collection_interface $repeats, proxy_interface $coursemodule = null, $type, times_interface $times, $visible, proxy_interface $subscription = null)
    {
    }
