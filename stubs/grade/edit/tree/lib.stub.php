...
abstract class grade_edit_tree_column
{
    ...
    abstract public function get_category_cell($category, $levelclass, $params);
    abstract public function get_item_cell($item, $params);
    abstract public function is_hidden($mode = 'simple');
