...
/**
 * Auto-generated stub file for Moodle's public/h5p/h5plib/v128/joubel/core/h5p.classes.php
 *
...
class H5PValidator
{
    ...
    private $h5pRequired = array('title' => '/^.{1,255}$/u', 'language' => '/^[-a-zA-Z]{1,10}$/', 'preloadedDependencies' => array('machineName' => '/^[\w0-9\-\.]{1,255}$/i', 'majorVersion' => '/^[0-9]{1,5}$/', 'minorVersion' => '/^[0-9]{1,5}$/'), 'mainLibrary' => '/^[$a-z_][0-9a-z_\.$]{1,254}$/i', 'embedTypes' => array('iframe', 'div'));
    private $h5pOptional = array(
        ...
        'yearsFrom' => '/^([0-9]{1,4})$/',
        'yearsTo' => '/^([0-9]{1,4})$/',
        'changes' => array('date' => '/^[0-9]{2}-[0-9]{2}-[0-9]{2} [0-9]{1,2}:[0-9]{2}:[0-9]{2}$/', 'author' => '/^.{1,255}$/', 'log' => '/^.{1,5000}$/s'),
...
class H5PCore
{
    public static $coreApi = array('majorVersion' => 1, 'minorVersion' => 28);
    public static $styles = array('styles/h5p-fonts.css', 'styles/h5p.css', 'styles/h5p-confirmation-dialog.css', 'styles/h5p-core-button.css', 'styles/h5p-theme.css', 'styles/h5p-theme-variables.css', 'styles/h5p-tooltip.css', 'styles/h5p-table.css');
    public static $scripts = array('js/jquery.js', 'js/h5p.js', 'js/h5p-event-dispatcher.js', 'js/h5p-x-api-event.js', 'js/h5p-x-api.js', 'js/h5p-content-type.js', 'js/h5p-confirmation-dialog.js', 'js/h5p-action-bar.js', 'js/request-queue.js', 'js/h5p-tooltip.js');
...
class H5PContentValidator
{
    ...
    private static $allowed_styleable_tags = ['span', 'p', 'div', 'h1', 'h2', 'h3', 'table', 'col', 'figure', 'td', 'th', 'li'];
