...
/**
 * Auto-generated stub file for Moodle's public/enrol/lti/classes/local/ltiadvantage/entity/deployment.php
 *
...
class deployment
{
     ...
     */
    private function __construct(string $deploymentname, string $deploymentid, int $registrationid, ?int $id = null, ?string $legacyconsumerkey = null)
    {
    }
    /**
     ...
     */
    public static function create(int $registrationid, string $deploymentid, string $deploymentname, ?int $id = null, ?string $legacyconsumerkey = null): deployment
    {
    }
    /**
     ...
     */
    public function add_resource_link(string $resourcelinkid, int $resourceid, ?int $contextid = null): resource_link
    {
    }
    /**
