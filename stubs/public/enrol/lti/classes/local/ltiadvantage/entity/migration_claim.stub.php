...
/**
 * Auto-generated stub file for Moodle's public/enrol/lti/classes/local/ltiadvantage/entity/migration_claim.php
 *
...
class migration_claim
{
     ...
     */
    public function __construct(array $claim, string $deploymentid, string $platform, string $clientid, string $exp, string $nonce, legacy_consumer_repository $legacyconsumerrepo)
    {
    }
    /**
     ...
     */
    private function verify_signature(string $consumerkey, string $signature, string $deploymentid, string $platform, string $clientid, string $exp, string $nonce): bool
    {
    }
    /**
