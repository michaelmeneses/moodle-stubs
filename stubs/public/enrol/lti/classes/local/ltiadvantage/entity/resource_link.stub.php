...
/**
 * Auto-generated stub file for Moodle's public/enrol/lti/classes/local/ltiadvantage/entity/resource_link.php
 *
...
class resource_link
{
     ...
     */
    private function __construct(string $resourcelinkid, int $deploymentid, int $resourceid, ?int $contextid = null, ?int $id = null)
    {
    }
    /**
     ...
     */
    public static function create(string $resourcelinkid, int $deploymentid, int $resourceid, ?int $contextid = null, ?int $id = null): resource_link
    {
    }
    /**
     ...
     */
    public function add_user(int $userid, string $sourceid, string $lang, string $city, string $country, string $institution, string $timezone, ?int $maildisplay = null): user
    {
    }
}