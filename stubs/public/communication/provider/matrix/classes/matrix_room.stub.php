...
/**
 * Auto-generated stub file for Moodle's public/communication/provider/matrix/classes/matrix_room.php
 *
...
class matrix_room
{
     ...
     * @return null|self
     */
    public static function load_by_processor_id(int $processorid): ?self
    {
    }
    /**
     ...
     */
    private function __construct(private stdClass $record)
    {
    }
    /**
     ...
     * @return self
     */
    public static function create_room_record(int $processorid, ?string $topic, ?string $roomid = null): self
    {
    }
    /**
     ...
     * @param string|null $topic The topic of the room for matrix
     */
    public function update_room_record(?string $roomid = null, ?string $topic = null): void
    {
    }
    /**
