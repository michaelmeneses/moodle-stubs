...
/**
 * Auto-generated stub file for Moodle's public/communication/provider/matrix/classes/local/spec/features/matrix/update_room_power_levels_v3.php
 *
...
trait update_room_power_levels_v3
{
     ...
     * @return Response
     */
    public function update_room_power_levels(string $roomid, array $users, int $ban = matrix_constants::POWER_LEVEL_MAXIMUM, int $invite = matrix_constants::POWER_LEVEL_MODERATOR, int $kick = matrix_constants::POWER_LEVEL_MODERATOR, array $notifications = ['room' => matrix_constants::POWER_LEVEL_MODERATOR], int $redact = matrix_constants::POWER_LEVEL_MODERATOR): Response
    {
    }
}