...
/**
 * Auto-generated stub file for Moodle's public/communication/provider/matrix/classes/local/spec/features/matrix/remove_member_from_room_v3.php
 *
...
trait remove_member_from_room_v3
{
     ...
     * @return Response
     */
    public function remove_member_from_room(string $roomid, string $userid): Response
    {
    }
}