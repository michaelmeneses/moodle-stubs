...
/**
 * Auto-generated stub file for Moodle's public/report/log/classes/renderable.php
 *
...
class report_log_renderable implements renderable
{
     ...
     */
    public function __construct($logreader = "", $course = 0, $userid = 0, $modid = 0, $action = "", $groupid = 0, $edulevel = -1, $showcourses = false, $showusers = false, $showreport = true, $showselectorform = true, $url = "", $date = 0, $logformat = 'showashtml', $page = 0, $perpage = 100, $order = "timecreated ASC", $origin = '', bool $isactivitypage = false, bool $iscoursepage = false, $sitecoursefilter = 0)
    {
    }
    /**
