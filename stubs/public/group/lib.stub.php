...
/**
 * Auto-generated stub file for Moodle's public/group/lib.php
 *
 ...
 */
function groups_get_potential_members($courseid, $roleid = null, $source = null, $orderby = 'lastname ASC, firstname ASC', $notingroup = null, $onlyactiveenrolments = false, $extrafields = [])
{
}
/**
 ...
 */
function groups_get_members_by_role(int $groupid, int $courseid, string $fields = 'u.*', ?string $sort = null, string $extrawheretest = '', array $whereorsortparams = [], string $joins = '')
{
}
/**
