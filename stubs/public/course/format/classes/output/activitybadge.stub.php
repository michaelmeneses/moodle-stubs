...
/**
 * Auto-generated stub file for Moodle's public/course/format/classes/output/activitybadge.php
 *
...
abstract class activitybadge implements named_templatable, \renderable
{
    ...
    public const STYLES = ['none' => 'badge-none', 'dark' => 'bg-dark text-white', 'danger' => 'bg-danger text-white', 'warning' => 'bg-warning text-dark', 'info' => 'bg-info text-white'];
