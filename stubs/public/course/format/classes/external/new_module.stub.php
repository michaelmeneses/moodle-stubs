...
/**
 * Auto-generated stub file for Moodle's public/course/format/classes/external/new_module.php
 *
...
class new_module extends external_api
{
     ...
     */
    public static function execute(int $courseid, string $modname, int $targetsectionid, ?int $targetcmid = null): string
    {
    }
    /**
     * Webservice returns.
