...
/**
 * Auto-generated stub file for Moodle's public/course/format/classes/stateactions.php
 *
...
class stateactions
{
     ...
     */
    #[\core\attribute\deprecated(replacement: 'stateactions::section_move_after', since: '4.4', mdl: 'MDL-77038', final: true)]
     ...
     * @param int|null $targetcmid not used
     */
    public function section_duplicate(stateupdates $updates, stdClass $course, array $ids = [], ?int $targetsectionid = null, ?int $targetcmid = null): void
    {
    }
    /**
     ...
     * @param int|null $targetcmid optional target cm id
     */
    #[\core\attribute\deprecated(replacement: 'new_module', since: '5.0', mdl: 'MDL-83469')]
    public function create_module(stateupdates $updates, stdClass $course, string $modname, int $targetsectionnum, ?int $targetcmid = null): void
    {
    }
    /**
     ...
     * @param int|null $targetcmid optional target cm id
     */
    public function new_module(stateupdates $updates, stdClass $course, string $modname, int $targetsectionid, ?int $targetcmid = null): void
    {
    }
}