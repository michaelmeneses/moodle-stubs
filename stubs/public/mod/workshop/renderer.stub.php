...
/**
 * Auto-generated stub file for Moodle's public/mod/workshop/renderer.php
 *
...
class mod_workshop_renderer extends plugin_renderer_base
{
     ...
     * @return string HTML to display.
     */
    public function view_page(workshop $workshop, workshop_user_plan $userplan, string $currentphasetitle, int $page, string $sortby, string $sorthow): string
    {
    }
    /**
     ...
     * @return string HTML to display.
     */
    public function view_submissions_report(workshop $workshop, workshop_user_plan $userplan, int $page, string $sortby, string $sorthow): string
    {
    }
}