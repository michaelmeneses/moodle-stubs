...
/**
 * Auto-generated stub file for Moodle's public/mod/bigbluebuttonbn/classes/local/proxy/bigbluebutton_proxy.php
 *
...
class bigbluebutton_proxy extends proxy_base
{
     ...
     * @return string
     */
    public static function get_join_url(instance $instance, ?string $createtime): string
    {
    }
    /**
     * Builds and returns a url for joining a BigBlueButton meeting.
     ...
     * @return string
     */
    public static function get_guest_join_url(instance $instance, ?string $createtime, string $username): string
    {
    }
    /**
     ...
     * @return string
     */
    private static function internal_get_join_url(instance $instance, ?string $jointime, ?string $userfullname = null, bool $isguestjoin = false): string
    {
    }
    /**
     * Get user avatar URL
     ...
     */
    public static function create_meeting(array $data, array $metadata, ?string $presentationname = null, ?string $presentationurl = null, ?int $instanceid = null): array
    {
    }
    /**
