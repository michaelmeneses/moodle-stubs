...
/**
 * Auto-generated stub file for Moodle's public/mod/glossary/formats/dictionary/dictionary_format.php
 *
 ...
 */
function glossary_show_entry_dictionary($course, $cm, $glossary, $entry, $mode = '', $hook = '', $printicons = 1, $aliases = true, $conceptheadinglevel = 3)
{
}
/**
 ...
 * @package mod_glossary
 */
function glossary_print_entry_dictionary($course, $cm, $glossary, $entry, $mode = '', $hook = '', $printicons = 1, $conceptheadinglevel = 3)
{
}