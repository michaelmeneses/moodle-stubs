...
/**
 * Auto-generated stub file for Moodle's public/mod/glossary/formats/TEMPLATE/TEMPLATE_format.php
 *
 ...
 */
function glossary_show_entry_TEMPLATE($course, $cm, $glossary, $entry, $mode = '', $hook = '', $printicons = 1, $aliases = true, $conceptheadinglevel = 3)
{
}
/**
 ...
 * @package mod_glossary
 */
function glossary_print_entry_TEMPLATE($course, $cm, $glossary, $entry, $mode = '', $hook = '', $printicons = 1, $conceptheadinglevel = 3)
{
}