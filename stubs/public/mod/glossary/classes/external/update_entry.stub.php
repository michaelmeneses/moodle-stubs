...
/**
 * Auto-generated stub file for Moodle's public/mod/glossary/classes/external/update_entry.php
 *
...
class update_entry extends external_api
{
     ...
     */
    public static function execute(int $entryid, string $concept, string $definition, int $definitionformat, array $options = []): array
    {
    }
    /**
     * Return.
