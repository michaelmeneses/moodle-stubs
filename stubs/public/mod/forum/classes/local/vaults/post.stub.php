...
/**
 * Auto-generated stub file for Moodle's public/mod/forum/classes/local/vaults/post.php
 *
...
class post extends db_table_vault
{
     ...
     * @return post_entity[]
     */
    public function get_from_discussion_ids(stdClass $user, array $discussionids, bool $canseeprivatereplies, string $orderby = ''): array
    {
    }
    /**
     ...
     * @return post_entity[]
     */
    public function get_from_filters(stdClass $user, array $filters, bool $canseeprivatereplies, string $orderby = ''): array
    {
    }
    /**
