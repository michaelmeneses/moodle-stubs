...
/**
 * Auto-generated stub file for Moodle's public/mod/forum/classes/local/renderers/discussion_list.php
 *
...
class discussion_list
{
     ...
     */
    public function render(stdClass $user, \cm_info $cm, ?int $groupid, ?int $sortorder, ?int $pageno, ?int $pagesize, ?int $displaymode = null, bool $enablediscussioncreation = true): string
    {
    }
    /**
