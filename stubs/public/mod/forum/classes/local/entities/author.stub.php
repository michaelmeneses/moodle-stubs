...
/**
 * Auto-generated stub file for Moodle's public/mod/forum/classes/local/entities/author.php
 *
...
class author
{
     ...
     */
    public function __construct(int $id, int $pictureitemid, string $firstname, string $lastname, string $fullname, string $email, bool $deleted, ?string $middlename = null, ?string $firstnamephonetic = null, ?string $lastnamephonetic = null, ?string $alternatename = null, ?string $imagealt = null, ?string $initials = null)
    {
    }
    /**
     * Return the id.
