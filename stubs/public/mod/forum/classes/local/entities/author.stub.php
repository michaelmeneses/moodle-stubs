...
class author
{
     ...
     */
    public function __construct(int $id, int $pictureitemid, string $firstname, string $lastname, string $fullname, string $email, bool $deleted, ?string $middlename = null, ?string $firstnamephonetic = null, ?string $lastnamephonetic = null, ?string $alternatename = null, ?string $imagealt = null)
    {
    }
    /**
     * Return the id.
