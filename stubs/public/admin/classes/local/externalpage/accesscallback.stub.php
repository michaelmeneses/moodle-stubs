...
/**
 * Auto-generated stub file for Moodle's public/admin/classes/local/externalpage/accesscallback.php
 *
...
class accesscallback extends admin_externalpage
{
     ...
     * @param bool $hidden
     */
    public function __construct(string $name, string $visiblename, string $url, callable $accesscheckcallback, bool $hidden = false)
    {
    }
    /**
