...
/**
 * Auto-generated stub file for Moodle's public/admin/tool/brickfield/classes/local/htmlchecker/common/checks/img_alt_not_place_holder.php
 *
...
class img_alt_not_place_holder extends brickfield_accessibility_test
{
    ...
    public $strings = ['en' => array('nbsp', '&nbsp;', 'spacer', 'image', 'img', 'photo'), 'es' => array('nbsp', '&nbsp;', 'spacer', 'espacio', 'imagen', 'img', 'foto')];
    /**
