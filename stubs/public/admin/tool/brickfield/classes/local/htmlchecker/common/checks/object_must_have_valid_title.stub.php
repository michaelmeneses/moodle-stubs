...
/**
 * Auto-generated stub file for Moodle's public/admin/tool/brickfield/classes/local/htmlchecker/common/checks/object_must_have_valid_title.php
 *
...
class object_must_have_valid_title extends brickfield_accessibility_test
{
    ...
    public $strings = ['en' => ['nbsp', '&nbsp;', 'object', 'an object', 'spacer', 'image', 'img', 'photo', ' '], 'es' => ['nbsp', '&nbsp;', 'objeto', 'un objeto', 'espacio', 'imagen', 'img', 'foto', ' ']];
    /**
