...
/**
 * Auto-generated stub file for Moodle's public/admin/tool/customlang/classes/local/mlang/logstatus.php
 *
...
class logstatus
{
     ...
     */
    public function __construct(string $message, string $errorlevel, ?string $filename = null, ?string $component = null, ?langstring $langstring = null)
    {
    }
    /**
     * Get the log message.
