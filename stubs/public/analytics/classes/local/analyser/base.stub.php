...
/**
 * Auto-generated stub file for Moodle's public/analytics/classes/local/analyser/base.php
 *
...
abstract class base
{
     ...
     */
    protected function get_iterator_sql(string $tablename, int $contextlevel, ?string $action = null, ?string $tablealias = null, array $contexts = [])
    {
    }
    /**
