...
/**
 * Auto-generated stub file for Moodle's public/repository/upload/lib.php
 *
...
class repository_upload extends repository
{
     ...
     */
    public function process_upload($saveasfilename, $maxbytes, $types = '*', $savepath = '/', $itemid = 0, $license = null, $author = '', $overwriteexisting = false, $areamaxbytes = FILE_AREA_MAX_BYTES_UNLIMITED)
    {
    }
    /**
