...
/**
 * Auto-generated stub file for Moodle's public/privacy/classes/manager.php
 *
...
class manager
{
     ...
     * @param array $params
     */
    protected function component_class_callback_failed(\Throwable $e, string $component, string $interface, string $methodname, array $params)
    {
    }
}