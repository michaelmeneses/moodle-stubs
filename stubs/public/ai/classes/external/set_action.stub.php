...
/**
 * Auto-generated stub file for Moodle's public/ai/classes/external/set_action.php
 *
...
class set_action extends external_api
{
     ...
     * @return array
     */
    public static function execute(string $plugin, int $state, int $providerid = 0): array
    {
    }
    /**
