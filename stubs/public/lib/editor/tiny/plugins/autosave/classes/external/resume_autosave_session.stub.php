...
/**
 * Auto-generated stub file for Moodle's public/lib/editor/tiny/plugins/autosave/classes/external/resume_autosave_session.php
 *
...
class resume_autosave_session extends external_api
{
     ...
     * @return null
     */
    public static function execute(int $contextid, string $pagehash, string $pageinstance, string $elementid, ?int $draftid): array
    {
    }
    /**
