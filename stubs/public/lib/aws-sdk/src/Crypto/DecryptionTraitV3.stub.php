...
/**
 * Auto-generated stub file for Moodle's public/lib/aws-sdk/src/Crypto/DecryptionTraitV3.php
 *
...
trait DecryptionTraitV3
{
     ...
     * @internal
     */
    public function decrypt(string $cipherText, MaterialsProviderInterfaceV3 $provider, MetadataEnvelope $envelope, string $commitmentPolicy, array $options = []): AesStreamInterface
    {
    }
    private function checkEnvelopeForExclusiveMapKeys(MetadataEnvelope $envelope, array $exclusiveKeys, string $errorMessage): void
    {
    }
    ...
    private function getTagFromCiphertextStream(StreamInterface $cipherText, $tagLength): string
    {
    }
    private function getStrippedCiphertextStream(StreamInterface $cipherText, $tagLength): LimitStream
    {
    }
    private function validateOptionsAndEnvelope(array $options, MetadataEnvelope $envelope, string $commitmentPolicy): void
    {
    }
    /**
     ...
     * @internal
     */
    protected function getNonCommitingDecryptingStream(string $cipherText, string $cek, array $cipherOptions): AesStreamInterface
    {
    }
    /**
     * Generates a stream that wraps the cipher text with the proper cipher and
