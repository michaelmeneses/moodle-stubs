...
/**
 * Auto-generated stub file for Moodle's public/lib/aws-sdk/src/S3/S3Transfer/Models/DownloadDirectoryRequest.php
 *
...
final class DownloadDirectoryRequest extends AbstractTransferRequest
{
     ...
     */
    public function __construct(string $sourceBucket, string $destinationDirectory, array $downloadRequestArgs = [], array $config = [], array $listeners = [], ?AbstractTransferListener $progressTracker = null)
    {
    }
    /**
     * @return string
