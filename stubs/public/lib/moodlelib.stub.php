...
/**
 * Auto-generated stub file for Moodle's public/lib/moodlelib.php
 *
 ...
 */
define('PARAM_CLEANHTML', null);
/**
 * PARAM_EMAIL - an email address following the RFC
 */
define('PARAM_EMAIL', null);
/**
 * PARAM_FILE - safe file name, all dangerous chars are stripped, protects against XSS, SQL injections and directory traversals
 */
define('PARAM_FILE', null);
/**
 ...
 */
define('PARAM_LOCALURL', null);
/**
 * PARAM_NOTAGS - all html tags are stripped from the text. Do not abuse this type.
 */
define('PARAM_NOTAGS', null);
/**
 ...
 */
function get_time_interval_string(int $time1, int $time2, string $format = '', bool $dropzeroes = false, bool $fullformat = false): string
{
}
/**
 ...
 */
function authenticate_user_login($username, $password, $ignorelockout = false, &$failurereason = null, $logintoken = false, string|bool $loginrecaptcha = false)
{
}
/**
 ...
 */
function password_is_legacy_hash(
    #[\SensitiveParameter]
    string $password
): bool
{
