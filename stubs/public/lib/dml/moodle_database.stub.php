...
/**
 * Auto-generated stub file for Moodle's public/lib/dml/moodle_database.php
 *
...
abstract class moodle_database
{
     ...
     */
    #[\core\attribute\deprecated(replacement: 'want_read_replica', since: '5.0', mdl: 'MDL-71257', reason: 'Renamed')]
     ...
     * @todo Final deprecation in Moodle 6.0. See MDL-83171.
     */
    #[\core\attribute\deprecated(replacement: 'perf_get_reads_replica', since: '5.0', mdl: 'MDL-71257', reason: 'Renamed')]
     ...
     */
    public function get_counted_records_sql(string $sql, string $fullcountcolumn, string $sort = '', ?array $params = null, int $limitfrom = 0, int $limitnum = 0): array
    {
    }
    /**
     ...
     * @return moodle_recordset A moodle_recordset instance..
     */
    public function get_counted_recordset_sql(string $sql, string $fullcountcolumn, string $sort = '', ?array $params = null, int $limitfrom = 0, int $limitnum = 0): moodle_recordset
    {
    }
    /**
     ...
     */
    private function generate_fullcount_sql(string $sql, ?array $params, string $fullcountcolumn): string
    {
    }
}