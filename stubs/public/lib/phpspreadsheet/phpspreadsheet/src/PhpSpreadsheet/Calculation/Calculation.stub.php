...
class Calculation
{
     ...
     * @var string[]
     */
    private static array $validLocaleLanguages = ['en'];
    /**
     ...
     */
    private static array $localeBoolean = ['TRUE' => 'TRUE', 'FALSE' => 'FALSE', 'NULL' => 'NULL'];
     ...
     */
    private static array $excelConstants = ['TRUE' => true, 'FALSE' => false, 'NULL' => null];
    ...
    private static function translateFormulaBlock(array $from, array $to, string $formula, int &$inFunctionBracesLevel, int &$inMatrixBracesLevel, string $fromSeparator, string $toSeparator): string
    {
    }
