...
/**
 * Auto-generated stub file for Moodle's public/lib/phpspreadsheet/phpspreadsheet/src/PhpSpreadsheet/Calculation/Financial/CashFlow/Constant/Periodic/Interest.php
 *
...
class Interest
{
     ...
     */
    public static function payment(mixed $interestRate, mixed $period, mixed $numberOfPeriods, mixed $presentValue, mixed $futureValue = 0, mixed $type = FinancialConstants::PAYMENT_END_OF_PERIOD): string|float
    {
    }
    /**
     * ISPMT.
     ...
     */
    public static function rate(mixed $numberOfPeriods, mixed $payment, mixed $presentValue, mixed $futureValue = 0.0, mixed $type = FinancialConstants::PAYMENT_END_OF_PERIOD, mixed $guess = 0.1): string|float
    {
    }
