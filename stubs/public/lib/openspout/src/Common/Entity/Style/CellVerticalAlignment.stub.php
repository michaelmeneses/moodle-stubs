...
/**
 * Auto-generated stub file for Moodle's public/lib/openspout/src/Common/Entity/Style/CellVerticalAlignment.php
 *
...
final class CellVerticalAlignment
{
    ...
    private const VALID_ALIGNMENTS = [self::AUTO => 1, self::BASELINE => 1, self::BOTTOM => 1, self::CENTER => 1, self::DISTRIBUTED => 1, self::JUSTIFY => 1, self::TOP => 1];
    /**
