...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/output/local/dropdown/dialog.php
 *
...
class dialog implements named_templatable, renderable
{
    ...
    public const POSITION = ['start' => 'dropdown-menu-start', 'end' => 'dropdown-menu-end'];
    /** Dropdown dialog positions. */
    public const WIDTH = ['default' => '', 'big' => 'dialog-big', 'small' => 'dialog-small'];
    /**
