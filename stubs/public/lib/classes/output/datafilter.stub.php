...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/output/datafilter.php
 *
...
abstract class datafilter implements renderable, templatable
{
     ...
     */
    protected function get_filter_object(string $name, string $title, bool $custom, bool $multiple, ?string $filterclass, array $values, bool $allowempty = false, ?stdClass $filteroptions = null, bool $required = false, array $joinlist = [self::JOINTYPE_NONE, self::JOINTYPE_ANY, self::JOINTYPE_ALL]): ?stdClass
    {
    }
}