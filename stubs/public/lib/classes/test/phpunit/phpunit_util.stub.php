...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/test/phpunit/phpunit_util.php
 *
...
namespace core\test\phpunit {
    ...
    class phpunit_util extends \core\test\testing_util
    {
         ...
         */
        protected static function get_coverage_info(string $fulldir, string $moodleroot): coverage_info
        {
        }
        /**
...
namespace {
    /**
     * Runtime class alias of \core\test\phpunit\phpunit_util registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class phpunit_util extends \core\test\phpunit\phpunit_util
    {
    }
}