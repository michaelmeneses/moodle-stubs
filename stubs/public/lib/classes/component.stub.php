...
namespace core {
    ...
    class component
    {
         ...
         * @var array<string>
         */
        protected static $composerautoloadfiles = ['public/lib/aws-sdk/src/functions.php', 'public/lib/guzzlehttp/guzzle/src/functions_include.php', 'public/lib/jmespath/src/JmesPath.php', 'public/lib/nikic/fast-route/src/functions.php', 'public/lib/php-di/php-di/src/functions.php', 'public/lib/ralouphie/getallheaders/src/getallheaders.php', 'public/lib/symfony/deprecation-contracts/function.php'];
        /**
