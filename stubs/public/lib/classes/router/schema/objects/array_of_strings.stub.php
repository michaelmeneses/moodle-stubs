...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/router/schema/objects/array_of_strings.php
 *
...
final class array_of_strings extends array_of_things implements referenced_object
{
     ...
     * @return string
     */
    protected function get_debug_info_for_validation_failure(param $type, string $value): string
    {
    }
}