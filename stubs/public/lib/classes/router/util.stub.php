...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/router/util.php
 *
...
class util
{
     ...
     */
    public static function throw_page_not_found(ServerRequestInterface $request, ResponseInterface $response, ?string $message = null, ?\Throwable $previous = null): ResponseInterface
    {
    }
    /**
     * Redirect to a URL.
