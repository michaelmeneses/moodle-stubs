...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/attribute/deprecated_with_reference.php
 *
...
class deprecated_with_reference extends deprecated
{
     ...
     */
    public function __construct(public readonly string $owner, ?string $replacement, ?string $since, ?string $reason, ?string $mdl, bool $final, bool $emit)
    {
    }
}