...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/event/user_created.php
 *
...
class user_created extends base
{
     ...
     * @return user_created
     */
    public static function create_from_user_id_on_restore(int $userid, string $restoreid, int $courseid): user_created
    {
    }
