...
/**
 * Auto-generated stub file for Moodle's public/lib/classes/check/result.php
 *
...
class result implements \renderable
{
     ...
     */
    public function __construct(string $status, string $summary, string $details = '', ?action_link $actionlink = null)
    {
    }
    /**
