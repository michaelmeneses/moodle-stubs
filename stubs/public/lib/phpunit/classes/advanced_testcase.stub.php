...
/**
 * Auto-generated stub file for Moodle's public/lib/phpunit/classes/advanced_testcase.php
 *
...
abstract class advanced_testcase extends base_testcase
{
     ...
     */
    public function mock_clock_with_incrementing(?int $starttime = null): \incrementing_clock
    {
    }
    /**
     ...
     * @return \frozen_clock
     */
    public function mock_clock_with_frozen(?int $time = null): \frozen_clock
    {
    }
    /**
     ...
     */
    protected function add_mocked_plugintype(string $plugintype, string $path, bool $deprecated = false): void
    {
    }
    /**
