...
namespace {
    /**
     * Runtime class alias of \Google\Service\PlayableLocations\Resource\V3 registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_PlayableLocations_Resource_V3 extends \Google\Service\PlayableLocations\Resource\V3
    {
    }
}