...
namespace {
    /**
     * Runtime class alias of \Google\Service\Docs\EmbeddedObjectBorder registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Docs_EmbeddedObjectBorder extends \Google\Service\Docs\EmbeddedObjectBorder
    {
    }
}