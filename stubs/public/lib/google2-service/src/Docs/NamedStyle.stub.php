...
namespace {
    /**
     * Runtime class alias of \Google\Service\Docs\NamedStyle registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Docs_NamedStyle extends \Google\Service\Docs\NamedStyle
    {
    }
}