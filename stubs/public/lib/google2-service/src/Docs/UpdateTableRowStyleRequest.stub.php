...
namespace {
    /**
     * Runtime class alias of \Google\Service\Docs\UpdateTableRowStyleRequest registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Docs_UpdateTableRowStyleRequest extends \Google\Service\Docs\UpdateTableRowStyleRequest
    {
    }
}