...
namespace {
    /**
     * Runtime class alias of \Google\Service\Docs\ParagraphStyle registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Docs_ParagraphStyle extends \Google\Service\Docs\ParagraphStyle
    {
    }
}