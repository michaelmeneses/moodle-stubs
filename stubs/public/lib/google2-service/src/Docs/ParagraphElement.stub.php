...
namespace {
    /**
     * Runtime class alias of \Google\Service\Docs\ParagraphElement registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Docs_ParagraphElement extends \Google\Service\Docs\ParagraphElement
    {
    }
}