...
namespace {
    /**
     * Runtime class alias of \Google\Service\Docs\ParagraphStyleSuggestionState registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Docs_ParagraphStyleSuggestionState extends \Google\Service\Docs\ParagraphStyleSuggestionState
    {
    }
}