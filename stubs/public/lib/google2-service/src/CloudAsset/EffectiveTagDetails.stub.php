...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudAsset\EffectiveTagDetails registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudAsset_EffectiveTagDetails extends \Google\Service\CloudAsset\EffectiveTagDetails
    {
    }
}