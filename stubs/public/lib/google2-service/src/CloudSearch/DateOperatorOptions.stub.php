...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudSearch/DateOperatorOptions.php
 *
...
namespace Google\Service\CloudSearch {
    class DateOperatorOptions extends \Google\Model
    {
         ...
         * of *closedon*. For searches on that data, queries like *closedon:* show
         * results only where the value of the *closeDate* property matches **. By
         ...
         * the content field for the indexed datasource. The operator name can only
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudSearch\DateOperatorOptions registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudSearch_DateOperatorOptions extends \Google\Service\CloudSearch\DateOperatorOptions
    {
    }
}