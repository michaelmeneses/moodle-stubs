...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudSearch\Annotation registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudSearch_Annotation extends \Google\Service\CloudSearch\Annotation
    {
    }
}