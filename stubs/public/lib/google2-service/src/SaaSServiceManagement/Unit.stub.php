...
namespace {
    /**
     * Runtime class alias of \Google\Service\SaaSServiceManagement\Unit registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_SaaSServiceManagement_Unit extends \Google\Service\SaaSServiceManagement\Unit
    {
    }
}