...
namespace {
    /**
     * Runtime class alias of \Google\Service\ServiceConsumerManagement\V1Beta1ProducerQuotaPolicy registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ServiceConsumerManagement_V1Beta1ProducerQuotaPolicy extends \Google\Service\ServiceConsumerManagement\V1Beta1ProducerQuotaPolicy
    {
    }
}