...
namespace {
    /**
     * Runtime class alias of \Google\Service\Fitness\DataPoint registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Fitness_DataPoint extends \Google\Service\Fitness\DataPoint
    {
    }
}