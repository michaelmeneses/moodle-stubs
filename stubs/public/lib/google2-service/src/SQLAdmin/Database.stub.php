...
namespace {
    /**
     * Runtime class alias of \Google\Service\SQLAdmin\Database registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_SQLAdmin_Database extends \Google\Service\SQLAdmin\Database
    {
    }
}