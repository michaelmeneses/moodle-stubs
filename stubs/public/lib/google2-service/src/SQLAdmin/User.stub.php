...
namespace {
    /**
     * Runtime class alias of \Google\Service\SQLAdmin\User registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_SQLAdmin_User extends \Google\Service\SQLAdmin\User
    {
    }
}