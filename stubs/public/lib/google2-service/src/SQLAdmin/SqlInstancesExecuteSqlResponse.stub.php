...
namespace {
    /**
     * Runtime class alias of \Google\Service\SQLAdmin\SqlInstancesExecuteSqlResponse registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_SQLAdmin_SqlInstancesExecuteSqlResponse extends \Google\Service\SQLAdmin\SqlInstancesExecuteSqlResponse
    {
    }
}