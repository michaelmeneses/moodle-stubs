...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/ShoppingContent/ShoppingAdsProgramStatusRegionStatus.php
 *
...
namespace Google\Service\ShoppingContent {
    class ShoppingAdsProgramStatusRegionStatus extends \Google\Collection
    {
         ...
         * provided.
         *
         * @param ShoppingAdsProgramStatusReviewIneligibilityReasonDetails $reviewIneligibilityReasonDetails
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\ShoppingContent\ShoppingAdsProgramStatusRegionStatus registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ShoppingContent_ShoppingAdsProgramStatusRegionStatus extends \Google\Service\ShoppingContent\ShoppingAdsProgramStatusRegionStatus
    {
    }
}