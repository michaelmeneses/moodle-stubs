...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/ShoppingContent/PostalCodeRange.php
 *
...
namespace Google\Service\ShoppingContent {
    class PostalCodeRange extends \Google\Model
    {
         ...
         * `"9410*"`, `"9*"`. Required.
         *
         * @param string $postalCodeRangeBegin
         */
         ...
         * the postal codes matching `postalCodeRangeBegin`.
         *
         * @param string $postalCodeRangeEnd
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\ShoppingContent\PostalCodeRange registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ShoppingContent_PostalCodeRange extends \Google\Service\ShoppingContent\PostalCodeRange
    {
    }
}