...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/ShoppingContent/ProductIssue.php
 *
...
namespace Google\Service\ShoppingContent {
    class ProductIssue extends \Google\Collection
    {
         ...
         * was identified. * `list-intro` - marks the paragraph that contains an intro
         * for a list. This paragraph will be always followed by a list. * `new-
         * element` - Present for new elements added to the pre-rendered content in
         * the future. To make sure that a new content element does not break your
         ...
         *
         * @param ProductIssueImpact $impact
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\ShoppingContent\ProductIssue registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ShoppingContent_ProductIssue extends \Google\Service\ShoppingContent\ProductIssue
    {
    }
}