...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/ShoppingContent/FreeListingsProgramStatus.php
 *
...
namespace Google\Service\ShoppingContent {
    class FreeListingsProgramStatus extends \Google\Collection
    {
         ...
         *
         * @param FreeListingsProgramStatusRegionStatus[] $regionStatuses
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\ShoppingContent\FreeListingsProgramStatus registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ShoppingContent_FreeListingsProgramStatus extends \Google\Service\ShoppingContent\FreeListingsProgramStatus
    {
    }
}