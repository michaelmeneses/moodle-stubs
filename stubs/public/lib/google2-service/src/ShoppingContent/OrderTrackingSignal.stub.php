...
namespace {
    /**
     * Runtime class alias of \Google\Service\ShoppingContent\OrderTrackingSignal registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ShoppingContent_OrderTrackingSignal extends \Google\Service\ShoppingContent\OrderTrackingSignal
    {
    }
}