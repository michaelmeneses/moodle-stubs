...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudMachineLearningEngine registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudMachineLearningEngine extends \Google\Service\CloudMachineLearningEngine
    {
    }
}