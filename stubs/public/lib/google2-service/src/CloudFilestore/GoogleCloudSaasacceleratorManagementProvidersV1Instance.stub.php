...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudFilestore\GoogleCloudSaasacceleratorManagementProvidersV1Instance registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudFilestore_GoogleCloudSaasacceleratorManagementProvidersV1Instance extends \Google\Service\CloudFilestore\GoogleCloudSaasacceleratorManagementProvidersV1Instance
    {
    }
}