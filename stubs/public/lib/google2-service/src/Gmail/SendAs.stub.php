...
namespace {
    /**
     * Runtime class alias of \Google\Service\Gmail\SendAs registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Gmail_SendAs extends \Google\Service\Gmail\SendAs
    {
    }
}