...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p4beta1TextAnnotationTextProperty registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p4beta1TextAnnotationTextProperty extends \Google\Service\Vision\GoogleCloudVisionV1p4beta1TextAnnotationTextProperty
    {
    }
}