...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Vision/GoogleCloudVisionV1p4beta1WebDetection.php
 *
...
namespace Google\Service\Vision {
    class GoogleCloudVisionV1p4beta1WebDetection extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudVisionV1p4beta1WebDetectionWebLabel[] $bestGuessLabels
         */
         ...
         * query image.
         *
         * @param GoogleCloudVisionV1p4beta1WebDetectionWebImage[] $fullMatchingImages
         */
         ...
         *
         * @param GoogleCloudVisionV1p4beta1WebDetectionWebPage[] $pagesWithMatchingImages
         */
         ...
         *
         * @param GoogleCloudVisionV1p4beta1WebDetectionWebImage[] $partialMatchingImages
         */
         ...
         *
         * @param GoogleCloudVisionV1p4beta1WebDetectionWebImage[] $visuallySimilarImages
         */
         ...
         *
         * @param GoogleCloudVisionV1p4beta1WebDetectionWebEntity[] $webEntities
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p4beta1WebDetection registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p4beta1WebDetection extends \Google\Service\Vision\GoogleCloudVisionV1p4beta1WebDetection
    {
    }
}