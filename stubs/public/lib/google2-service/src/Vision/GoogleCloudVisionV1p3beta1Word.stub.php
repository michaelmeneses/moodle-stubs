...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Vision/GoogleCloudVisionV1p3beta1Word.php
 *
...
namespace Google\Service\Vision {
    class GoogleCloudVisionV1p3beta1Word extends \Google\Collection
    {
         ...
         * reading order.
         *
         * @param GoogleCloudVisionV1p3beta1Symbol[] $symbols
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p3beta1Word registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p3beta1Word extends \Google\Service\Vision\GoogleCloudVisionV1p3beta1Word
    {
    }
}