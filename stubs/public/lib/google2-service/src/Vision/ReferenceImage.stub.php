...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Vision/ReferenceImage.php
 *
...
namespace Google\Service\Vision {
    class ReferenceImage extends \Google\Collection
    {
         ...
         *
         * @param BoundingPoly[] $boundingPolys
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\ReferenceImage registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_ReferenceImage extends \Google\Service\Vision\ReferenceImage
    {
    }
}