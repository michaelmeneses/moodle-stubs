...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p3beta1WebDetectionWebPage registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetectionWebPage extends \Google\Service\Vision\GoogleCloudVisionV1p3beta1WebDetectionWebPage
    {
    }
}