...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Vision/GoogleCloudVisionV1p3beta1WebDetection.php
 *
...
namespace Google\Service\Vision {
    class GoogleCloudVisionV1p3beta1WebDetection extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudVisionV1p3beta1WebDetectionWebLabel[] $bestGuessLabels
         */
         ...
         *
         * @param GoogleCloudVisionV1p3beta1WebDetectionWebPage[] $pagesWithMatchingImages
         */
         ...
         *
         * @param GoogleCloudVisionV1p3beta1WebDetectionWebImage[] $visuallySimilarImages
         */
         ...
         *
         * @param GoogleCloudVisionV1p3beta1WebDetectionWebEntity[] $webEntities
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p3beta1WebDetection registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetection extends \Google\Service\Vision\GoogleCloudVisionV1p3beta1WebDetection
    {
    }
}