...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Vision/GoogleCloudVisionV1p3beta1Paragraph.php
 *
...
namespace Google\Service\Vision {
    class GoogleCloudVisionV1p3beta1Paragraph extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudVisionV1p3beta1Word[] $words
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p3beta1Paragraph registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p3beta1Paragraph extends \Google\Service\Vision\GoogleCloudVisionV1p3beta1Paragraph
    {
    }
}