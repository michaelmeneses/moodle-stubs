...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Vision/GoogleCloudVisionV1p4beta1EntityAnnotation.php
 *
...
namespace Google\Service\Vision {
    class GoogleCloudVisionV1p4beta1EntityAnnotation extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudVisionV1p4beta1LocationInfo[] $locations
         */
         ...
         *
         * @param GoogleCloudVisionV1p4beta1Property[] $properties
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p4beta1EntityAnnotation registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p4beta1EntityAnnotation extends \Google\Service\Vision\GoogleCloudVisionV1p4beta1EntityAnnotation
    {
    }
}