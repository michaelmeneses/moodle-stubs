...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vision\GoogleCloudVisionV1p1beta1AnnotateFileResponse registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vision_GoogleCloudVisionV1p1beta1AnnotateFileResponse extends \Google\Service\Vision\GoogleCloudVisionV1p1beta1AnnotateFileResponse
    {
    }
}