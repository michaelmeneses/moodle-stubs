...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/FirebaseAppHosting/DnsRecord.php
 *
...
namespace Google\Service\FirebaseAppHosting {
    class DnsRecord extends \Google\Collection
    {
        /**
         * No action necessary.
         */
         ...
         * IPv6 addresses a domain directs traffic towards.
         */
         ...
         * `bar.foo.com` has its own set of CAA records. CAA records are optional. If
         * a domain and its parents have no CAA records, all CAs are authorized to
         * mint certificates on its behalf. In general, App Hosting only asks you to
         * modify CAA records when doing so is required to unblock SSL cert creation.
         */
        public const TYPE_CAA = 'CAA';
        protected $collection_key = 'relevantState';
        /**
         ...
         * to. Populated for all records with an `ADD` or `REMOVE` required action.
         *
         * @param string[] $relevantState
         */
        public function setRelevantState($relevantState)
        {
        }
        /**
         * @return string[]
         */
        public function getRelevantState()
        {
        }
        /**
         * Output only. An enum that indicates the a required action for this record.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\FirebaseAppHosting\DnsRecord registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_FirebaseAppHosting_DnsRecord extends \Google\Service\FirebaseAppHosting\DnsRecord
    {
    }
}