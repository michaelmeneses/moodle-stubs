...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Meet.php
 *
...
namespace Google\Service {
    ...
    class Meet extends \Google\Service
    {
        ...
        const MEETINGS_SPACE_SETTINGS = "https://www.googleapis.com/auth/meetings.space.settings";
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Meet registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Meet extends \Google\Service\Meet
    {
    }
}