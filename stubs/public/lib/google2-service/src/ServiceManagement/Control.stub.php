...
namespace {
    /**
     * Runtime class alias of \Google\Service\ServiceManagement\Control registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ServiceManagement_Control extends \Google\Service\ServiceManagement\Control
    {
    }
}