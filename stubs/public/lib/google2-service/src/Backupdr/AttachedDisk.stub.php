...
namespace {
    /**
     * Runtime class alias of \Google\Service\Backupdr\AttachedDisk registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Backupdr_AttachedDisk extends \Google\Service\Backupdr\AttachedDisk
    {
    }
}