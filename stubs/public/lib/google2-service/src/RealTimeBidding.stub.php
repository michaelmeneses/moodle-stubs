...
namespace {
    /**
     * Runtime class alias of \Google\Service\RealTimeBidding registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_RealTimeBidding extends \Google\Service\RealTimeBidding
    {
    }
}