...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DataCatalog/GoogleCloudDatacatalogV1MigrationConfig.php
 *
...
namespace Google\Service\DataCatalog {
    class GoogleCloudDatacatalogV1MigrationConfig extends \Google\Model
    {
         ...
         * migration is not enabled, this field is not set.
         *
         * @param string $templateMigrationEnabledTime
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DataCatalog\GoogleCloudDatacatalogV1MigrationConfig registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DataCatalog_GoogleCloudDatacatalogV1MigrationConfig extends \Google\Service\DataCatalog\GoogleCloudDatacatalogV1MigrationConfig
    {
    }
}