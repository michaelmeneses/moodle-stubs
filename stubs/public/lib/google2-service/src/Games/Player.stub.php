...
namespace {
    /**
     * Runtime class alias of \Google\Service\Games\Player registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Games_Player extends \Google\Service\Games\Player
    {
    }
}