...
namespace {
    /**
     * Runtime class alias of \Google\Service\GKEHub\Origin registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_GKEHub_Origin extends \Google\Service\GKEHub\Origin
    {
    }
}