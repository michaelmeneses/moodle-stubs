...
namespace {
    /**
     * Runtime class alias of \Google\Service\GKEHub\Fleet registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_GKEHub_Fleet extends \Google\Service\GKEHub\Fleet
    {
    }
}