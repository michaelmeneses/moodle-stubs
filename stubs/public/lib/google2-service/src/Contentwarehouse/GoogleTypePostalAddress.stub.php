...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Contentwarehouse/GoogleTypePostalAddress.php
 *
...
namespace Google\Service\Contentwarehouse {
    class GoogleTypePostalAddress extends \Google\Collection
    {
         ...
         * make it explicit (For example "ja" for large-to-small ordering and "ja-
         * Latn" or "en" for small-to-large). This way, the most specific line of an
         * address can be selected based on the language. The minimum permitted
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Contentwarehouse\GoogleTypePostalAddress registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Contentwarehouse_GoogleTypePostalAddress extends \Google\Service\Contentwarehouse\GoogleTypePostalAddress
    {
    }
}