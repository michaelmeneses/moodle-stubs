...
namespace {
    /**
     * Runtime class alias of \Google\Service\DisplayVideo\LineItem registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DisplayVideo_LineItem extends \Google\Service\DisplayVideo\LineItem
    {
    }
}