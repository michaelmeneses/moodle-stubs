...
namespace {
    /**
     * Runtime class alias of \Google\Service\DisplayVideo\ObaIcon registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DisplayVideo_ObaIcon extends \Google\Service\DisplayVideo\ObaIcon
    {
    }
}