...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Cloudchannel/GoogleCloudChannelV1CreateEntitlementRequest.php
 *
...
namespace Google\Service\Cloudchannel {
    class GoogleCloudChannelV1CreateEntitlementRequest extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudChannelV1Entitlement $entitlement
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Cloudchannel\GoogleCloudChannelV1CreateEntitlementRequest registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Cloudchannel_GoogleCloudChannelV1CreateEntitlementRequest extends \Google\Service\Cloudchannel\GoogleCloudChannelV1CreateEntitlementRequest
    {
    }
}