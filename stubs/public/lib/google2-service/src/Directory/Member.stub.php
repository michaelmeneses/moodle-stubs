...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Directory/Member.php
 *
...
namespace Google\Service\Directory {
    ...
    {
        protected $internal_gapi_mappings = ["deliverySettings" => "delivery_settings"];
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Directory\Member registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Directory_Member extends \Google\Service\Directory\Member
    {
    }
}