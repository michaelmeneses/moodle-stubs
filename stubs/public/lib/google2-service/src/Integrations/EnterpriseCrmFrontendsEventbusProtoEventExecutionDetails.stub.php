...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Integrations/EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails.php
 *
...
namespace Google\Service\Integrations {
    class EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails extends \Google\Collection
    {
         ...
         *
         * @param EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot[] $eventExecutionSnapshot
         */
         ...
         * The execution state of this event.
         *
         * Accepted values: UNSPECIFIED, ON_HOLD, IN_PROCESS, SUCCEEDED, FAILED,
         * CANCELED, RETRY_ON_HOLD, SUSPENDED
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Integrations\EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Integrations_EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails extends \Google\Service\Integrations\EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails
    {
    }
}