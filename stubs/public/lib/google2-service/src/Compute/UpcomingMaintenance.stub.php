...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/UpcomingMaintenance.php
 *
...
namespace Google\Service\Compute {
    class UpcomingMaintenance extends \Google\Collection
    {
        ...
        /**
         * Multiple maintenance types in one window. This is only intended to be used
         * for groups.
         */
         ...
         * Indicates whether the UpcomingMaintenance will be triggered on VM shutdown.
         *
         * @param bool $maintenanceOnShutdown
         */
         ...
         * The reasons for the maintenance. Only valid for vms.
         *
         * @param string[] $maintenanceReasons
         */
         ...
         * Defines the type of maintenance.
         *
         * Accepted values: MULTIPLE, SCHEDULED, UNKNOWN_TYPE, UNSCHEDULED
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\UpcomingMaintenance registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_UpcomingMaintenance extends \Google\Service\Compute\UpcomingMaintenance
    {
    }
}