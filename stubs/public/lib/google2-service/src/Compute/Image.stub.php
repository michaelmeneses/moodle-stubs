...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Image registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Image extends \Google\Service\Compute\Image
    {
    }
}