...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\DiskType registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_DiskType extends \Google\Service\Compute\DiskType
    {
    }
}