...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/PacketMirroringFilter.php
 *
...
namespace Google\Service\Compute {
    class PacketMirroringFilter extends \Google\Collection
    {
        ...
        protected $internal_gapi_mappings = ["iPProtocols" => "IPProtocols"];
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\PacketMirroringFilter registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_PacketMirroringFilter extends \Google\Service\Compute\PacketMirroringFilter
    {
    }
}