...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/TCPHealthCheck.php
 *
...
namespace Google\Service\Compute {
    class TCPHealthCheck extends \Google\Model
    {
         ...
         * For details, see: https://cloud.google.com/load-balancing/docs/health-
         * check-concepts#criteria-protocol-ssl-tcp
         *
         * @var string
         */
        public $response;
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\TCPHealthCheck registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_TCPHealthCheck extends \Google\Service\Compute\TCPHealthCheck
    {
    }
}