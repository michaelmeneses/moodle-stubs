...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Zone registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Zone extends \Google\Service\Compute\Zone
    {
    }
}