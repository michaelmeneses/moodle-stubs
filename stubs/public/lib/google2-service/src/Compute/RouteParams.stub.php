...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/RouteParams.php
 *
...
namespace Google\Service\Compute {
    class RouteParams extends \Google\Model
    {
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\RouteParams registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_RouteParams extends \Google\Service\Compute\RouteParams
    {
    }
}