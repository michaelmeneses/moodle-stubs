...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Metadata registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Metadata extends \Google\Service\Compute\Metadata
    {
    }
}