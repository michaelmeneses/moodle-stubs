...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/SubnetworkParams.php
 *
...
namespace Google\Service\Compute {
    class SubnetworkParams extends \Google\Model
    {
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\SubnetworkParams registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_SubnetworkParams extends \Google\Service\Compute\SubnetworkParams
    {
    }
}