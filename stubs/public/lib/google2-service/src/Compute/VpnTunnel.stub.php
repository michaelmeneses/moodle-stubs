...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\VpnTunnel registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_VpnTunnel extends \Google\Service\Compute\VpnTunnel
    {
    }
}