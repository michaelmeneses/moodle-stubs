...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/TargetVpnGateways.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class TargetVpnGateways extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (targetVpnGateways.aggregatedList)
         *
         ...
         * theLabeling Resources documentation. (targetVpnGateways.setLabels)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\TargetVpnGateways registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_TargetVpnGateways extends \Google\Service\Compute\Resource\TargetVpnGateways
    {
    }
}