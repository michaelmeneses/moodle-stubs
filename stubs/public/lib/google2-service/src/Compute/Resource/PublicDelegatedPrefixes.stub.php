...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/PublicDelegatedPrefixes.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class PublicDelegatedPrefixes extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (publicDelegatedPrefixes.aggregatedList)
         *
         ...
         * @param string $region The name of theregion where the public delegated prefix
         ...
         * in the request. This method supportsPATCH semantics and usesJSON merge patch
         * format and processing rules. (publicDelegatedPrefixes.patch)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\PublicDelegatedPrefixes registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_PublicDelegatedPrefixes extends \Google\Service\Compute\Resource\PublicDelegatedPrefixes
    {
    }
}