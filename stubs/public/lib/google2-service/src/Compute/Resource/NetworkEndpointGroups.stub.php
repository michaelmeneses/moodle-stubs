...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/NetworkEndpointGroups.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class NetworkEndpointGroups extends \Google\Service\Resource
    {
         ...
         *
         * @param string $project Project ID for this request.
         * @param string $zone The name of thezone where the network endpoint group is
         * located. It should comply with RFC1035.
         * @param array $optParams Optional parameters.
         *
         * @opt_param string filter A filter expression that filters resources listed in
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\NetworkEndpointGroups registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_NetworkEndpointGroups extends \Google\Service\Compute\Resource\NetworkEndpointGroups
    {
    }
}