...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/RegionDisks.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class RegionDisks extends \Google\Service\Resource
    {
         ...
         * However, deleting a disk does not delete anysnapshots previously made from
         * the disk. You must separatelydelete snapshots. (regionDisks.delete)
         *
         * @param string $project Project ID for this request.
         * @param string $region Name of the region for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\RegionDisks registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_RegionDisks extends \Google\Service\Compute\Resource\RegionDisks
    {
    }
}