...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/GlobalOperations.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class GlobalOperations extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (globalOperations.aggregatedList)
         *
         ...
         * retry     if the operation is not `DONE`. (globalOperations.wait)
         *
         * @param string $project Project ID for this request.
         * @param string $operation Name of the Operations resource to return, or its
         * unique numeric identifier.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\GlobalOperations registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_GlobalOperations extends \Google\Service\Compute\Resource\GlobalOperations
    {
    }
}