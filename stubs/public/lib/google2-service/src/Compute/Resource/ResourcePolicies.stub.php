...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/ResourcePolicies.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class ResourcePolicies extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (resourcePolicies.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\ResourcePolicies registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_ResourcePolicies extends \Google\Service\Compute\Resource\ResourcePolicies
    {
    }
}