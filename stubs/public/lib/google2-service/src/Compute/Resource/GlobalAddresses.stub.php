...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/GlobalAddresses.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class GlobalAddresses extends \Google\Service\Resource
    {
        ...
        /**
         * Sets the labels on a GlobalAddress. To learn more about labels, read
         * theLabeling Resources documentation. (globalAddresses.setLabels)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\GlobalAddresses registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_GlobalAddresses extends \Google\Service\Compute\Resource\GlobalAddresses
    {
    }
}