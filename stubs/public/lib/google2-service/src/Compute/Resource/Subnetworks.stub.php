...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/Subnetworks.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class Subnetworks extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (subnetworks.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\Subnetworks registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_Subnetworks extends \Google\Service\Compute\Resource\Subnetworks
    {
    }
}