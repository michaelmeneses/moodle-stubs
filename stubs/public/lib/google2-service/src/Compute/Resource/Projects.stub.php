...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/Projects.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class Projects extends \Google\Service\Resource
    {
        ...
        /**
         * Moves a persistent disk from one zone to another. *Note*: The moveDisk API
         * will be deprecated on September 29, 2026.
         *
         ...
         * location of a disk](https://cloud.google.com/compute/docs/disks/migrate-to-
         * hyperdisk#migrate-to-hd).
         *
         * Projects that already use the moveDisk API can continue usage until September
         * 29, 2026.
         *
         * Starting November 1, 2025, API responses will include a warning message in
         * the response body about the upcoming deprecation. You can skip the message to
        ...
        /**
         * Enables the usage export feature and sets theusage export bucket where
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\Projects registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_Projects extends \Google\Service\Compute\Resource\Projects
    {
    }
}