...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/Reservations.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class Reservations extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (reservations.aggregatedList)
         *
         ...
         * more information, readModifying reservations. (reservations.resize)
         *
         * @param string $project Project ID for this request.
         * @param string $zone Name of the zone for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\Reservations registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_Reservations extends \Google\Service\Compute\Resource\Reservations
    {
    }
}