...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/TargetInstances.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class TargetInstances extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (targetInstances.aggregatedList)
         *
         ...
         * instance. For more information, seeGoogle Cloud Armor Overview
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\TargetInstances registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_TargetInstances extends \Google\Service\Compute\Resource\TargetInstances
    {
    }
}