...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/Regions.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class Regions extends \Google\Service\Resource
    {
         ...
         * if the organization policy constraint compute.requireBasicQuotaInResponse is
         * enforced. This constraint, when enforced, disables the fail-open behaviour
         * when quota information (the `items.quotas` field) is unavailable for the
         * region. It is recommended to use the default setting for the constraint
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\Regions registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_Regions extends \Google\Service\Compute\Resource\Regions
    {
    }
}