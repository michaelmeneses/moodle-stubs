...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/VpnGateways.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class VpnGateways extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (vpnGateways.aggregatedList)
         *
         ...
         * Resources documentation. (vpnGateways.setLabels)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\VpnGateways registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_VpnGateways extends \Google\Service\Compute\Resource\VpnGateways
    {
    }
}