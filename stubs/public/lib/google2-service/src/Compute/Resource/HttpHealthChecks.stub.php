...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/HttpHealthChecks.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class HttpHealthChecks extends \Google\Service\Resource
    {
         ...
         * merge patch format and processing rules. (httpHealthChecks.patch)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\HttpHealthChecks registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_HttpHealthChecks extends \Google\Service\Compute\Resource\HttpHealthChecks
    {
    }
}