...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/StoragePoolTypes.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class StoragePoolTypes extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (storagePoolTypes.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\StoragePoolTypes registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_StoragePoolTypes extends \Google\Service\Compute\Resource\StoragePoolTypes
    {
    }
}