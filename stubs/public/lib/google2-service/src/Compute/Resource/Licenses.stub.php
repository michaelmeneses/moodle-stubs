...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/Licenses.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class Licenses extends \Google\Service\Resource
    {
         ...
         * intended for use only by third-party partners who are creatingCloud
         ...
         * to the respective image project, such as debian-cloud orwindows-cloud.
         * Caution* This resource is intended for use only by third-party partners who
         * are creatingCloud Marketplace images. (licenses.listLicenses)
         *
         * @param string $project Project ID for this request.
         * @param array $optParams Optional parameters.
         *
         ...
         * creatingCloud Marketplace images. (licenses.testIamPermissions)
         *
         * @param string $project Project ID for this request.
         * @param string $resource Name or id of the resource for this request.
         ...
         * is intended for use only by third-party partners who are creatingCloud
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\Licenses registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_Licenses extends \Google\Service\Compute\Resource\Licenses
    {
    }
}