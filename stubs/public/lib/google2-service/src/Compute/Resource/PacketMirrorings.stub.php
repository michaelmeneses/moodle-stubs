...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/PacketMirrorings.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class PacketMirrorings extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (packetMirrorings.aggregatedList)
         *
         ...
         * and processing rules. (packetMirrorings.patch)
         *
         * @param string $project Project ID for this request.
         * @param string $region Name of the region for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\PacketMirrorings registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_PacketMirrorings extends \Google\Service\Compute\Resource\PacketMirrorings
    {
    }
}