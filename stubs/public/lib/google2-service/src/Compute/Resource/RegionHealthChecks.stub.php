...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/RegionHealthChecks.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class RegionHealthChecks extends \Google\Service\Resource
    {
         ...
         * merge patch format and processing rules. (regionHealthChecks.patch)
         *
         * @param string $project Project ID for this request.
         * @param string $region Name of the region scoping this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\RegionHealthChecks registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_RegionHealthChecks extends \Google\Service\Compute\Resource\RegionHealthChecks
    {
    }
}