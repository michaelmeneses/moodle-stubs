...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/TargetHttpsProxies.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class TargetHttpsProxies extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (targetHttpsProxies.aggregatedList)
         *
         ...
         * request. This method supports PATCH semantics and usesJSON merge patch format
         * and processing rules. (targetHttpsProxies.patch)
         *
         * @param string $project Project ID for this request.
         * @param string $targetHttpsProxy Name of the TargetHttpsProxy resource to
         * patch.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\TargetHttpsProxies registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_TargetHttpsProxies extends \Google\Service\Compute\Resource\TargetHttpsProxies
    {
    }
}