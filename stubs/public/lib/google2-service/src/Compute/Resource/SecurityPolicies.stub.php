...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/SecurityPolicies.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class SecurityPolicies extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (securityPolicies.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\SecurityPolicies registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_SecurityPolicies extends \Google\Service\Compute\Resource\SecurityPolicies
    {
    }
}