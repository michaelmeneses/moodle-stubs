...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/SslCertificates.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class SslCertificates extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (sslCertificates.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\SslCertificates registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_SslCertificates extends \Google\Service\Compute\Resource\SslCertificates
    {
    }
}