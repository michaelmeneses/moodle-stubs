...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/InstanceTemplates.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class InstanceTemplates extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (instanceTemplates.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\InstanceTemplates registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_InstanceTemplates extends \Google\Service\Compute\Resource\InstanceTemplates
    {
    }
}