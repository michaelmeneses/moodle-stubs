...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/TargetHttpProxies.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class TargetHttpProxies extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (targetHttpProxies.aggregatedList)
         *
         ...
         * and processing rules. (targetHttpProxies.patch)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\TargetHttpProxies registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_TargetHttpProxies extends \Google\Service\Compute\Resource\TargetHttpProxies
    {
    }
}