...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/HealthChecks.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class HealthChecks extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (healthChecks.aggregatedList)
         *
         ...
         * merge patch format and processing rules. (healthChecks.patch)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\HealthChecks registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_HealthChecks extends \Google\Service\Compute\Resource\HealthChecks
    {
    }
}