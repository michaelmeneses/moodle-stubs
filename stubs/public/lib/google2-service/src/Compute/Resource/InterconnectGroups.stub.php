...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/InterconnectGroups.php
 *
...
namespace Google\Service\Compute\Resource {
     ...
     *   $interconnectGroups = $computeService->interconnectGroups;
     *  </code>
     */
    class InterconnectGroups extends \Google\Service\Resource
    {
        /**
         * Create Interconnects with redundancy by creating them in a specified
         * interconnect group. (interconnectGroups.createMembers)
         *
         * @param string $project Project ID for this request.
         * @param string $interconnectGroup Name of the group resource to create members
         * for.
         * @param InterconnectGroupsCreateMembersRequest $postBody
         * @param array $optParams Optional parameters.
         * @return Operation
         * @throws \Google\Service\Exception
         */
        public function createMembers($project, $interconnectGroup, InterconnectGroupsCreateMembersRequest $postBody, $optParams = [])
        {
        }
        /**
         ...
         *
         * @param string $project Project ID for this request.
         * @param string $interconnectGroup Name of the InterconnectGroup resource to
         * delete.
         * @param array $optParams Optional parameters.
         *
         ...
         * @throws \Google\Service\Exception
         */
        public function delete($project, $interconnectGroup, $optParams = [])
        {
        }
        /**
         ...
         * @throws \Google\Service\Exception
         */
        public function get($project, $interconnectGroup, $optParams = [])
        {
        }
        /**
         * Gets the access control policy for a resource. May be empty if no such policy
         * or resource exists. (interconnectGroups.getIamPolicy)
         *
         * @param string $project Project ID for this request.
         ...
         * @throws \Google\Service\Exception
         */
        public function getOperationalStatus($project, $interconnectGroup, $optParams = [])
        {
        }
        /**
         * Creates a InterconnectGroup in the specified project in the given scope using
         * the parameters that are included in the request. (interconnectGroups.insert)
         *
         * @param string $project Project ID for this request.
         * @param InterconnectGroup $postBody
         * @param array $optParams Optional parameters.
         *
         * @opt_param string requestId An optional request ID to identify requests.
         * Specify a unique request ID so that if you must retry your request, the
         ...
         * @throws \Google\Service\Exception
         */
        public function insert($project, InterconnectGroup $postBody, $optParams = [])
        {
        }
        /**
         * Lists the InterconnectGroups for a project in the given scope.
         * (interconnectGroups.listInterconnectGroups)
         *
         * @param string $project Project ID for this request.
         * @param array $optParams Optional parameters.
         *
         ...
         * with an error code.
         * @return InterconnectGroupsListResponse
         * @throws \Google\Service\Exception
         */
        public function listInterconnectGroups($project, $optParams = [])
        {
        }
        /**
         ...
         * format and processing rules. (interconnectGroups.patch)
         *
         * @param string $project Project ID for this request.
         * @param string $interconnectGroup Name of the InterconnectGroup resource to
         * patch.
         ...
         * @throws \Google\Service\Exception
         */
        public function patch($project, $interconnectGroup, InterconnectGroup $postBody, $optParams = [])
        {
        }
        /**
         * Sets the access control policy on the specified resource. Replaces any
         * existing policy. (interconnectGroups.setIamPolicy)
         *
         * @param string $project Project ID for this request.
         * @param string $resource Name or id of the resource for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\InterconnectGroups registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_InterconnectGroups extends \Google\Service\Compute\Resource\InterconnectGroups
    {
    }
}