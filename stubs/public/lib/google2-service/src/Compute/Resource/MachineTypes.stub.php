...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/MachineTypes.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class MachineTypes extends \Google\Service\Resource
    {
         ...
         * parameter to `true`. (machineTypes.aggregatedList)
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\MachineTypes registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_MachineTypes extends \Google\Service\Compute\Resource\MachineTypes
    {
    }
}