...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/MachineImages.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class MachineImages extends \Google\Service\Resource
    {
        ...
        /**
         * Sets the labels on a machine image. To learn more about labels, read
         * theLabeling Resources documentation. (machineImages.setLabels)
         *
         * @param string $project Project ID for this request.
         * @param string $resource Name or id of the resource for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\MachineImages registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_MachineImages extends \Google\Service\Compute\Resource\MachineImages
    {
    }
}