...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Resource/TargetGrpcProxies.php
 *
...
namespace Google\Service\Compute\Resource {
    ...
    class TargetGrpcProxies extends \Google\Service\Resource
    {
         ...
         * and processing rules. (targetGrpcProxies.patch)
         *
         * @param string $project Project ID for this request.
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Resource\TargetGrpcProxies registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Resource_TargetGrpcProxies extends \Google\Service\Compute\Resource\TargetGrpcProxies
    {
    }
}