...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\TargetTcpProxy registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_TargetTcpProxy extends \Google\Service\Compute\TargetTcpProxy
    {
    }
}