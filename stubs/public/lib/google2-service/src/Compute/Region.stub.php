...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Region registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Region extends \Google\Service\Compute\Region
    {
    }
}