...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/Network.php
 *
...
namespace Google\Service\Compute {
    class Network extends \Google\Collection
    {
        ...
        protected $internal_gapi_mappings = ["iPv4Range" => "IPv4Range"];
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\Network registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_Network extends \Google\Service\Compute\Network
    {
    }
}