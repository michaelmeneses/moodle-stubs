...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/HealthCheckServicesList.php
 *
...
namespace Google\Service\Compute {
    class HealthCheckServicesList extends \Google\Collection
    {
         ...
         *
         * @param HealthCheckServicesListWarning $warning
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\HealthCheckServicesList registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_HealthCheckServicesList extends \Google\Service\Compute\HealthCheckServicesList
    {
    }
}