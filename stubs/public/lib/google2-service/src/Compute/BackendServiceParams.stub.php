...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Compute/BackendServiceParams.php
 *
...
namespace Google\Service\Compute {
    class BackendServiceParams extends \Google\Model
    {
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Compute\BackendServiceParams registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Compute_BackendServiceParams extends \Google\Service\Compute\BackendServiceParams
    {
    }
}