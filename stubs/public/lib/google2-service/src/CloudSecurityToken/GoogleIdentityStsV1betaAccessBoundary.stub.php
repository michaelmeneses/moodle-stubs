...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudSecurityToken/GoogleIdentityStsV1betaAccessBoundary.php
 *
...
namespace Google\Service\CloudSecurityToken {
    class GoogleIdentityStsV1betaAccessBoundary extends \Google\Collection
    {
         ...
         *
         * @param GoogleIdentityStsV1betaAccessBoundaryRule[] $accessBoundaryRules
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudSecurityToken\GoogleIdentityStsV1betaAccessBoundary registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudSecurityToken_GoogleIdentityStsV1betaAccessBoundary extends \Google\Service\CloudSecurityToken\GoogleIdentityStsV1betaAccessBoundary
    {
    }
}