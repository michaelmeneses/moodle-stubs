...
namespace {
    /**
     * Runtime class alias of \Google\Service\Bigquery\Table registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Bigquery_Table extends \Google\Service\Bigquery\Table
    {
    }
}