...
namespace {
    /**
     * Runtime class alias of \Google\Service\Dataproc\ShieldedInstanceConfig registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Dataproc_ShieldedInstanceConfig extends \Google\Service\Dataproc\ShieldedInstanceConfig
    {
    }
}