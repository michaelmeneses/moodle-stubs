...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DataPortability.php
 *
...
namespace Google\Service {
    ...
    class DataPortability extends \Google\Service
    {
        ...
        const DATAPORTABILITY_CHROME_READING_LIST = "https://www.googleapis.com/auth/dataportability.chrome.reading_list";
        ...
        const DATAPORTABILITY_DISCOVER_NOT_INTERESTED = "https://www.googleapis.com/auth/dataportability.discover.not_interested";
        /** Move a copy of the places you labeled on Maps. */
        const DATAPORTABILITY_MAPS_ALIASED_PLACES = "https://www.googleapis.com/auth/dataportability.maps.aliased_places";
        ...
        const DATAPORTABILITY_MAPS_COMMUTE_SETTINGS = "https://www.googleapis.com/auth/dataportability.maps.commute_settings";
        /** Move a copy of your electric vehicle profile on Maps. */
        const DATAPORTABILITY_MAPS_EV_PROFILE = "https://www.googleapis.com/auth/dataportability.maps.ev_profile";
        /** Move a copy of the corrections you made to places or map information on Maps. */
        const DATAPORTABILITY_MAPS_FACTUAL_CONTRIBUTIONS = "https://www.googleapis.com/auth/dataportability.maps.factual_contributions";
        /** Move a copy of your updates to places on Maps. */
        const DATAPORTABILITY_MAPS_OFFERING_CONTRIBUTIONS = "https://www.googleapis.com/auth/dataportability.maps.offering_contributions";
        /** Move a copy of the photos and videos you posted on Maps. */
        const DATAPORTABILITY_MAPS_PHOTOS_VIDEOS = "https://www.googleapis.com/auth/dataportability.maps.photos_videos";
        /** Move a copy of the questions and answers you posted on Maps. */
        const DATAPORTABILITY_MAPS_QUESTIONS_ANSWERS = "https://www.googleapis.com/auth/dataportability.maps.questions_answers";
        ...
        const DATAPORTABILITY_MAPS_STARRED_PLACES = "https://www.googleapis.com/auth/dataportability.maps.starred_places";
        /** Move a copy of your vehicle profile on Maps. */
        const DATAPORTABILITY_MAPS_VEHICLE_PROFILE = "https://www.googleapis.com/auth/dataportability.maps.vehicle_profile";
        ...
        const DATAPORTABILITY_ORDER_RESERVE_PURCHASES_RESERVATIONS = "https://www.googleapis.com/auth/dataportability.order_reserve.purchases_reservations";
        ...
        const DATAPORTABILITY_PLAY_LIBRARY = "https://www.googleapis.com/auth/dataportability.play.library";
        ...
        const DATAPORTABILITY_SEARCH_UGC_COMMENTS = "https://www.googleapis.com/auth/dataportability.search_ugc.comments";
        /** Move a copy of your media reviews on Google Search. */
        const DATAPORTABILITY_SEARCH_UGC_MEDIA_REVIEWS_AND_STARS = "https://www.googleapis.com/auth/dataportability.search_ugc.media.reviews_and_stars";
        /** Move a copy of your self-reported video streaming provider preferences from Google Search and Google TV. */
        const DATAPORTABILITY_SEARCH_UGC_MEDIA_STREAMING_VIDEO_PROVIDERS = "https://www.googleapis.com/auth/dataportability.search_ugc.media.streaming_video_providers";
        /** Move a copy of your indicated thumbs up and thumbs down on media in Google Search and Google TV. */
        const DATAPORTABILITY_SEARCH_UGC_MEDIA_THUMBS = "https://www.googleapis.com/auth/dataportability.search_ugc.media.thumbs";
        /** Move a copy of information about the movies and TV shows you marked as watched on Google Search and Google TV. */
        const DATAPORTABILITY_SEARCH_UGC_MEDIA_WATCHED = "https://www.googleapis.com/auth/dataportability.search_ugc.media.watched";
        ...
        const DATAPORTABILITY_YOUTUBE_CONVERSATIONS = "https://www.googleapis.com/auth/dataportability.youtube.conversations";
        /** Move a copy of your YouTube messages in live chat. */
        const DATAPORTABILITY_YOUTUBE_LIVE_CHAT = "https://www.googleapis.com/auth/dataportability.youtube.live_chat";
        ...
        const DATAPORTABILITY_YOUTUBE_PRIVATE_PLAYLISTS = "https://www.googleapis.com/auth/dataportability.youtube.private_playlists";
        /** Move a copy of your private YouTube videos and information about them. */
        const DATAPORTABILITY_YOUTUBE_PRIVATE_VIDEOS = "https://www.googleapis.com/auth/dataportability.youtube.private_videos";
        /** Move a copy of your public YouTube playlists. */
        const DATAPORTABILITY_YOUTUBE_PUBLIC_PLAYLISTS = "https://www.googleapis.com/auth/dataportability.youtube.public_playlists";
        /** Move a copy of your public YouTube videos and information about them. */
        const DATAPORTABILITY_YOUTUBE_PUBLIC_VIDEOS = "https://www.googleapis.com/auth/dataportability.youtube.public_videos";
        ...
        const DATAPORTABILITY_YOUTUBE_UNLISTED_PLAYLISTS = "https://www.googleapis.com/auth/dataportability.youtube.unlisted_playlists";
        /** Move a copy of your unlisted YouTube videos and information about them. */
        const DATAPORTABILITY_YOUTUBE_UNLISTED_VIDEOS = "https://www.googleapis.com/auth/dataportability.youtube.unlisted_videos";
        public $accessType;
        public $archiveJobs;
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DataPortability registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DataPortability extends \Google\Service\DataPortability
    {
    }
}