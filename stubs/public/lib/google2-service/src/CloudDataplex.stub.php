...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudDataplex registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudDataplex extends \Google\Service\CloudDataplex
    {
    }
}