...
namespace {
    /**
     * Runtime class alias of \Google\Service\Dataflow\JobMessage registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Dataflow_JobMessage extends \Google\Service\Dataflow\JobMessage
    {
    }
}