...
namespace {
    /**
     * Runtime class alias of \Google\Service\Apigee\GoogleCloudApigeeV1Instance registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Apigee_GoogleCloudApigeeV1Instance extends \Google\Service\Apigee\GoogleCloudApigeeV1Instance
    {
    }
}