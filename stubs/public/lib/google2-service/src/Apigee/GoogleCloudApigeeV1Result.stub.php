...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Apigee/GoogleCloudApigeeV1Result.php
 *
...
namespace Google\Service\Apigee {
    class GoogleCloudApigeeV1Result extends \Google\Collection
    {
        ...
        protected $internal_gapi_mappings = ["actionResult" => "ActionResult"];
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Apigee\GoogleCloudApigeeV1Result registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Apigee_GoogleCloudApigeeV1Result extends \Google\Service\Apigee\GoogleCloudApigeeV1Result
    {
    }
}