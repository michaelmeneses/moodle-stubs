...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudRetail/Resource/ProjectsLocationsCatalogs.php
 *
...
namespace Google\Service\CloudRetail\Resource {
    ...
    class ProjectsLocationsCatalogs extends \Google\Service\Resource
    {
         ...
         * completion. "user-data" will use the dataset imported through
         * CompletionService.ImportCompletionData. `cloud-retail` will use the dataset
         * generated by Cloud Retail based on user events. If left empty, completions
         * will be fetched from the `user-data` dataset. Current supported values: *
         * user-data * cloud-retail: This option requires enabling auto-learning
         * function first. See
         ...
         * with UserEvent.entity to get per-entity autocomplete results. This field will
         * be applied to `completion_results` only. It has no effect on the
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudRetail\Resource\ProjectsLocationsCatalogs registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudRetail_Resource_ProjectsLocationsCatalogs extends \Google\Service\CloudRetail\Resource\ProjectsLocationsCatalogs
    {
    }
}