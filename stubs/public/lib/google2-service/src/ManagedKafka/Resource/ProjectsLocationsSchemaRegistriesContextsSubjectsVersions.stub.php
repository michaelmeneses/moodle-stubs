...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/ManagedKafka/Resource/ProjectsLocationsSchemaRegistriesContextsSubjectsVersions.php
 *
...
namespace Google\Service\ManagedKafka\Resource {
     ...
     *   $versions = $managedkafkaService->projects_locations_schemaRegistries_contexts_subjects_versions;
     *  </code>
     */
    class ProjectsLocationsSchemaRegistriesContextsSubjectsVersions extends \Google\Service\Resource
    {
        /**
         ...
         * the subject.
         * (versions.listProjectsLocationsSchemaRegistriesContextsSubjectsVersions)
         *
         ...
         * @throws \Google\Service\Exception
         */
        public function listProjectsLocationsSchemaRegistriesContextsSubjectsVersions($parent, $optParams = [])
        {
        }
    }
}
namespace {
    /**
     * Runtime class alias of \Google\Service\ManagedKafka\Resource\ProjectsLocationsSchemaRegistriesContextsSubjectsVersions registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ManagedKafka_Resource_ProjectsLocationsSchemaRegistriesContextsSubjectsVersions extends \Google\Service\ManagedKafka\Resource\ProjectsLocationsSchemaRegistriesContextsSubjectsVersions
    {
    }
}