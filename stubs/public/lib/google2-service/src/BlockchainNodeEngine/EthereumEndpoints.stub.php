...
namespace {
    /**
     * Runtime class alias of \Google\Service\BlockchainNodeEngine\EthereumEndpoints registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_BlockchainNodeEngine_EthereumEndpoints extends \Google\Service\BlockchainNodeEngine\EthereumEndpoints
    {
    }
}