...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DataLabeling/GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse.php
 *
...
namespace Google\Service\DataLabeling {
    class GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudDatalabelingV1p2alpha1LabelStats $labelStats
         */
         ...
         *
         * @param GoogleCloudDatalabelingV1p2alpha1OutputConfig $outputConfig
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DataLabeling\GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DataLabeling_GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse extends \Google\Service\DataLabeling\GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse
    {
    }
}