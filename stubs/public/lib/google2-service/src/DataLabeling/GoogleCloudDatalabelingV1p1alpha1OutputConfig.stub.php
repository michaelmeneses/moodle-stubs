...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DataLabeling/GoogleCloudDatalabelingV1p1alpha1OutputConfig.php
 *
...
namespace Google\Service\DataLabeling {
    class GoogleCloudDatalabelingV1p1alpha1OutputConfig extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudDatalabelingV1p1alpha1GcsDestination $gcsDestination
         */
         ...
         *
         * @param GoogleCloudDatalabelingV1p1alpha1GcsFolderDestination $gcsFolderDestination
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DataLabeling\GoogleCloudDatalabelingV1p1alpha1OutputConfig registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DataLabeling_GoogleCloudDatalabelingV1p1alpha1OutputConfig extends \Google\Service\DataLabeling\GoogleCloudDatalabelingV1p1alpha1OutputConfig
    {
    }
}