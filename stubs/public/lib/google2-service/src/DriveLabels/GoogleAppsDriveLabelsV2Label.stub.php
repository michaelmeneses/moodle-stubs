...
namespace {
    /**
     * Runtime class alias of \Google\Service\DriveLabels\GoogleAppsDriveLabelsV2Label registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DriveLabels_GoogleAppsDriveLabelsV2Label extends \Google\Service\DriveLabels\GoogleAppsDriveLabelsV2Label
    {
    }
}