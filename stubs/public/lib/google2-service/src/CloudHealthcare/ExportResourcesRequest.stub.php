...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudHealthcare/ExportResourcesRequest.php
 *
...
namespace Google\Service\CloudHealthcare {
    ...
    {
        protected $internal_gapi_mappings = ["since" => "_since", "type" => "_type"];
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudHealthcare\ExportResourcesRequest registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudHealthcare_ExportResourcesRequest extends \Google\Service\CloudHealthcare\ExportResourcesRequest
    {
    }
}