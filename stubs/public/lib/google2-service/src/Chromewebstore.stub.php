...
namespace {
    /**
     * Runtime class alias of \Google\Service\Chromewebstore registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Chromewebstore extends \Google\Service\Chromewebstore
    {
    }
}