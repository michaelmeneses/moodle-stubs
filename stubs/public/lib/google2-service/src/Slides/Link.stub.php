...
namespace {
    /**
     * Runtime class alias of \Google\Service\Slides\Link registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Slides_Link extends \Google\Service\Slides\Link
    {
    }
}