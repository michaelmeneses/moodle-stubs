...
namespace {
    /**
     * Runtime class alias of \Google\Service\Slides\Table registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Slides_Table extends \Google\Service\Slides\Table
    {
    }
}