...
namespace {
    /**
     * Runtime class alias of \Google\Service\Dfareporting\TagData registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Dfareporting_TagData extends \Google\Service\Dfareporting\TagData
    {
    }
}