...
namespace {
    /**
     * Runtime class alias of \Google\Service\Dfareporting\Account registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Dfareporting_Account extends \Google\Service\Dfareporting\Account
    {
    }
}