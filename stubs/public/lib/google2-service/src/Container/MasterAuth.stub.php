...
namespace {
    /**
     * Runtime class alias of \Google\Service\Container\MasterAuth registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Container_MasterAuth extends \Google\Service\Container\MasterAuth
    {
    }
}