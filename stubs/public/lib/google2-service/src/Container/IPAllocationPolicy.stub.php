...
namespace {
    /**
     * Runtime class alias of \Google\Service\Container\IPAllocationPolicy registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Container_IPAllocationPolicy extends \Google\Service\Container\IPAllocationPolicy
    {
    }
}