...
namespace {
    /**
     * Runtime class alias of \Google\Service\Container\NodePool registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Container_NodePool extends \Google\Service\Container\NodePool
    {
    }
}