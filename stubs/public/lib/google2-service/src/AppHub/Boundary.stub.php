...
namespace {
    /**
     * Runtime class alias of \Google\Service\AppHub\Boundary registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_AppHub_Boundary extends \Google\Service\AppHub\Boundary
    {
    }
}