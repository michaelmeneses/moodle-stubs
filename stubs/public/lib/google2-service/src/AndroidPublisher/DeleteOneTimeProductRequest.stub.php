...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/AndroidPublisher/DeleteOneTimeProductRequest.php
 *
...
namespace Google\Service\AndroidPublisher {
    class DeleteOneTimeProductRequest extends \Google\Model
    {
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\AndroidPublisher\DeleteOneTimeProductRequest registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_AndroidPublisher_DeleteOneTimeProductRequest extends \Google\Service\AndroidPublisher\DeleteOneTimeProductRequest
    {
    }
}