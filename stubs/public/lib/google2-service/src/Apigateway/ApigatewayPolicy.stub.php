...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Apigateway/ApigatewayPolicy.php
 *
...
namespace Google\Service\Apigateway {
    class ApigatewayPolicy extends \Google\Collection
    {
         ...
         *
         * @param ApigatewayAuditConfig[] $auditConfigs
         */
         ...
         * the `Policy`.
         *
         * @param ApigatewayBinding[] $bindings
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Apigateway\ApigatewayPolicy registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Apigateway_ApigatewayPolicy extends \Google\Service\Apigateway\ApigatewayPolicy
    {
    }
}