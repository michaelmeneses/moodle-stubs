...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Apigateway/ApigatewayBinding.php
 *
...
namespace Google\Service\Apigateway {
    class ApigatewayBinding extends \Google\Collection
    {
         ...
         * policies).
         *
         * @param ApigatewayExpr $condition
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Apigateway\ApigatewayBinding registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Apigateway_ApigatewayBinding extends \Google\Service\Apigateway\ApigatewayBinding
    {
    }
}