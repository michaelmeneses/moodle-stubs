...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/HangoutsChat.php
 *
...
namespace Google\Service {
    ...
    class HangoutsChat extends \Google\Service
    {
        ...
        const CHAT_APP_DELETE = "https://www.googleapis.com/auth/chat.app.delete";
        /** On their own behalf, apps in Google Chat can see, add, update, and remove members from conversations and spaces. */
        const CHAT_APP_MEMBERSHIPS = "https://www.googleapis.com/auth/chat.app.memberships";
        /** On their own behalf, apps in Google Chat can see all messages and their associated reactions and message content. */
        const CHAT_APP_MESSAGES_READONLY = "https://www.googleapis.com/auth/chat.app.messages.readonly";
        ...
        const CHAT_APP_SPACES = "https://www.googleapis.com/auth/chat.app.spaces";
        /** On their own behalf, apps in Google Chat can create conversations and spaces. */
        const CHAT_APP_SPACES_CREATE = "https://www.googleapis.com/auth/chat.app.spaces.create";
        /** Private Service: https://www.googleapis.com/auth/chat.bot. */
        const CHAT_BOT = "https://www.googleapis.com/auth/chat.bot";
        /** View, create, and delete custom emoji in Google Chat. */
        const CHAT_CUSTOMEMOJIS = "https://www.googleapis.com/auth/chat.customemojis";
        /** View custom emoji in Google Chat. */
        const CHAT_CUSTOMEMOJIS_READONLY = "https://www.googleapis.com/auth/chat.customemojis.readonly";
        ...
        const CHAT_USERS_SPACESETTINGS = "https://www.googleapis.com/auth/chat.users.spacesettings";
        public $customEmojis;
        public $media;
        public $spaces;
...
namespace {
    /**
     * Runtime class alias of \Google\Service\HangoutsChat registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_HangoutsChat extends \Google\Service\HangoutsChat
    {
    }
}