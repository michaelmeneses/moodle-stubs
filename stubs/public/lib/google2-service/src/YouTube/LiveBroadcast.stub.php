...
namespace {
    /**
     * Runtime class alias of \Google\Service\YouTube\LiveBroadcast registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_YouTube_LiveBroadcast extends \Google\Service\YouTube\LiveBroadcast
    {
    }
}