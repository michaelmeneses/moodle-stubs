...
namespace {
    /**
     * Runtime class alias of \Google\Service\BeyondCorp\AppGateway registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_BeyondCorp_AppGateway extends \Google\Service\BeyondCorp\AppGateway
    {
    }
}