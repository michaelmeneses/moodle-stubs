...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudDeploy\Release registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudDeploy_Release extends \Google\Service\CloudDeploy\Release
    {
    }
}