...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Sheets/ChartDateTimeRule.php
 *
...
namespace Google\Service\Sheets {
    class ChartDateTimeRule extends \Google\Model
    {
         ...
         */
        public const TYPE_CHART_DATE_TIME_RULE_TYPE_UNSPECIFIED = 'CHART_DATE_TIME_RULE_TYPE_UNSPECIFIED';
        /**
         ...
         * The type of date-time grouping to apply.
         *
         * Accepted values: CHART_DATE_TIME_RULE_TYPE_UNSPECIFIED, SECOND, MINUTE,
         * HOUR, HOUR_MINUTE, HOUR_MINUTE_AMPM, DAY_OF_WEEK, DAY_OF_YEAR,
         * DAY_OF_MONTH, DAY_MONTH, MONTH, QUARTER, YEAR, YEAR_MONTH, YEAR_QUARTER,
         * YEAR_MONTH_DAY
         *
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Sheets\ChartDateTimeRule registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Sheets_ChartDateTimeRule extends \Google\Service\Sheets\ChartDateTimeRule
    {
    }
}