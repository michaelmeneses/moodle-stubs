...
namespace {
    /**
     * Runtime class alias of \Google\Service\Sheets\Response registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Sheets_Response extends \Google\Service\Sheets\Response
    {
    }
}