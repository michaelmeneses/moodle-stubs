...
namespace {
    /**
     * Runtime class alias of \Google\Service\Sheets\PivotTable registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Sheets_PivotTable extends \Google\Service\Sheets\PivotTable
    {
    }
}