...
namespace {
    /**
     * Runtime class alias of \Google\Service\Testing\AndroidRoboTest registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Testing_AndroidRoboTest extends \Google\Service\Testing\AndroidRoboTest
    {
    }
}