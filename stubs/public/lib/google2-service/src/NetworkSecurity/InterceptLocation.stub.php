...
namespace {
    /**
     * Runtime class alias of \Google\Service\NetworkSecurity\InterceptLocation registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_NetworkSecurity_InterceptLocation extends \Google\Service\NetworkSecurity\InterceptLocation
    {
    }
}