...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/NetworkSecurity/InterceptDeploymentGroupDeployment.php
 *
...
namespace Google\Service\NetworkSecurity {
    class InterceptDeploymentGroupDeployment extends \Google\Model
    {
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\NetworkSecurity\InterceptDeploymentGroupDeployment registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_NetworkSecurity_InterceptDeploymentGroupDeployment extends \Google\Service\NetworkSecurity\InterceptDeploymentGroupDeployment
    {
    }
}