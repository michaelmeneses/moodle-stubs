...
namespace {
    /**
     * Runtime class alias of \Google\Service\FirebaseRealtimeDatabase registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_FirebaseRealtimeDatabase extends \Google\Service\FirebaseRealtimeDatabase
    {
    }
}