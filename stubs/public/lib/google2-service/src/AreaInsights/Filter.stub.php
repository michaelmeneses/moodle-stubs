...
namespace {
    /**
     * Runtime class alias of \Google\Service\AreaInsights\Filter registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_AreaInsights_Filter extends \Google\Service\AreaInsights\Filter
    {
    }
}