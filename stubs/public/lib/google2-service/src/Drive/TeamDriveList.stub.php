...
namespace {
    /**
     * Runtime class alias of \Google\Service\Drive\TeamDriveList registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Drive_TeamDriveList extends \Google\Service\Drive\TeamDriveList
    {
    }
}