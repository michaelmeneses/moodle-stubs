...
namespace {
    /**
     * Runtime class alias of \Google\Service\Logging\SavedQuery registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Logging_SavedQuery extends \Google\Service\Logging\SavedQuery
    {
    }
}