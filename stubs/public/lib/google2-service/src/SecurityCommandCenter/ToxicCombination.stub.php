...
namespace {
    /**
     * Runtime class alias of \Google\Service\SecurityCommandCenter\ToxicCombination registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_SecurityCommandCenter_ToxicCombination extends \Google\Service\SecurityCommandCenter\ToxicCombination
    {
    }
}