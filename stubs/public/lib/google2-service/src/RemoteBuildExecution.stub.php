...
namespace {
    /**
     * Runtime class alias of \Google\Service\RemoteBuildExecution registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_RemoteBuildExecution extends \Google\Service\RemoteBuildExecution
    {
    }
}