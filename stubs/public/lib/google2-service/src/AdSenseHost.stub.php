...
namespace {
    /**
     * Runtime class alias of \Google\Service\AdSenseHost registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_AdSenseHost extends \Google\Service\AdSenseHost
    {
    }
}