...
namespace {
    /**
     * Runtime class alias of \Google\Service\BackupforGKE\RetentionPolicyDetails registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_BackupforGKE_RetentionPolicyDetails extends \Google\Service\BackupforGKE\RetentionPolicyDetails
    {
    }
}