...
namespace {
    /**
     * Runtime class alias of \Google\Service\BackupforGKE\Restore registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_BackupforGKE_Restore extends \Google\Service\BackupforGKE\Restore
    {
    }
}