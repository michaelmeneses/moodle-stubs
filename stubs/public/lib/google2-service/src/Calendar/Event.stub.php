...
namespace {
    /**
     * Runtime class alias of \Google\Service\Calendar\Event registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Calendar_Event extends \Google\Service\Calendar\Event
    {
    }
}