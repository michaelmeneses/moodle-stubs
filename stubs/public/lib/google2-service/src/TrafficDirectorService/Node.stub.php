...
namespace {
    /**
     * Runtime class alias of \Google\Service\TrafficDirectorService\Node registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_TrafficDirectorService_Node extends \Google\Service\TrafficDirectorService\Node
    {
    }
}