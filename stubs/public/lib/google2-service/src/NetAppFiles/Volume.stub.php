...
namespace {
    /**
     * Runtime class alias of \Google\Service\NetAppFiles\Volume registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_NetAppFiles_Volume extends \Google\Service\NetAppFiles\Volume
    {
    }
}