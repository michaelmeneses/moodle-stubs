...
namespace {
    /**
     * Runtime class alias of \Google\Service\ApiKeysService\V2Key registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_ApiKeysService_V2Key extends \Google\Service\ApiKeysService\V2Key
    {
    }
}