...
namespace {
    /**
     * Runtime class alias of \Google\Service\Spanner\IndexAdvice registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Spanner_IndexAdvice extends \Google\Service\Spanner\IndexAdvice
    {
    }
}