...
namespace {
    /**
     * Runtime class alias of \Google\Service\VMMigrationService registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_VMMigrationService extends \Google\Service\VMMigrationService
    {
    }
}