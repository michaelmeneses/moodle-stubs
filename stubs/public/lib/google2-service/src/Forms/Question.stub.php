...
namespace {
    /**
     * Runtime class alias of \Google\Service\Forms\Question registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Forms_Question extends \Google\Service\Forms\Question
    {
    }
}