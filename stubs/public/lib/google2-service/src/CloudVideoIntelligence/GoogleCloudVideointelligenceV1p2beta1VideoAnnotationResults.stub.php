...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudVideoIntelligence/GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults.php
 *
...
namespace Google\Service\CloudVideoIntelligence {
    class GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1ExplicitContentAnnotation $explicitAnnotation
         */
         ...
         *
         * @deprecated
         * @param GoogleCloudVideointelligenceV1p2beta1FaceAnnotation[] $faceAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1FaceDetectionAnnotation[] $faceDetectionAnnotations
         */
         ...
         * unique label.
         *
         * @param GoogleCloudVideointelligenceV1p2beta1LabelAnnotation[] $frameLabelAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation[] $logoRecognitionAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation[] $objectAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1PersonDetectionAnnotation[] $personDetectionAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1LabelAnnotation[] $segmentLabelAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1LabelAnnotation[] $segmentPresenceLabelAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1VideoSegment[] $shotAnnotations
         */
         ...
         * each unique label.
         *
         * @param GoogleCloudVideointelligenceV1p2beta1LabelAnnotation[] $shotLabelAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1LabelAnnotation[] $shotPresenceLabelAnnotations
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1SpeechTranscription[] $speechTranscriptions
         */
         ...
         *
         * @param GoogleCloudVideointelligenceV1p2beta1TextAnnotation[] $textAnnotations
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudVideoIntelligence\GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults extends \Google\Service\CloudVideoIntelligence\GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults
    {
    }
}