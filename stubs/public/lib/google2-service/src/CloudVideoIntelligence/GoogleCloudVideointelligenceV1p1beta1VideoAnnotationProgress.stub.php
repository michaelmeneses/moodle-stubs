...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudVideoIntelligence/GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress.php
 *
...
namespace Google\Service\CloudVideoIntelligence {
    class GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudVideointelligenceV1p1beta1ExportToOutputUriStatus $exportStatus
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudVideoIntelligence\GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress extends \Google\Service\CloudVideoIntelligence\GoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress
    {
    }
}