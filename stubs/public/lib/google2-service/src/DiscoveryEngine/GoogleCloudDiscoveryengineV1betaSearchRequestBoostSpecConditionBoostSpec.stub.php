...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpecConditionBoostSpec.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpecConditionBoostSpec extends \Google\Model
    {
         ...
         * attribute value.
         *
         * @param GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpecConditionBoostSpecBoostControlSpec $boostControlSpec
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpecConditionBoostSpec registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpecConditionBoostSpec extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpecConditionBoostSpec
    {
    }
}