...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1betaEvaluation.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1betaEvaluation extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudDiscoveryengineV1betaEvaluationEvaluationSpec $evaluationSpec
         */
         ...
         * state is SUCCEEDED.
         *
         * @param GoogleCloudDiscoveryengineV1betaQualityMetrics $qualityMetrics
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaEvaluation registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaEvaluation extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaEvaluation
    {
    }
}