...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpecControlPoint[] $controlPoints
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec
    {
    }
}