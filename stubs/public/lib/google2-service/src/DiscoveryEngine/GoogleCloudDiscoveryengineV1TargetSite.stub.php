...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1TargetSite.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1TargetSite extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudDiscoveryengineV1TargetSiteFailureReason $failureReason
         */
         ...
         *
         * @param GoogleCloudDiscoveryengineV1SiteVerificationInfo $siteVerificationInfo
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1TargetSite registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1TargetSite extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1TargetSite
    {
    }
}