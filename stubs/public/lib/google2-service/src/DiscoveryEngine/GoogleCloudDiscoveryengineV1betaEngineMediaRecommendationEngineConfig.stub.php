...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfig.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfig extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfigEngineFeaturesConfig $engineFeaturesConfig
         */
         ...
         *
         * @param GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig $optimizationObjectiveConfig
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfig registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfig extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaEngineMediaRecommendationEngineConfig
    {
    }
}