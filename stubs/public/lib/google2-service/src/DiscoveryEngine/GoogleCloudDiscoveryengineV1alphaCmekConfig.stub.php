...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1alphaCmekConfig.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1alphaCmekConfig extends \Google\Collection
    {
        /**
        ...
        protected $singleRegionKeysType = GoogleCloudDiscoveryengineV1alphaSingleRegionKey::class;
         ...
         *
         * @param GoogleCloudDiscoveryengineV1alphaSingleRegionKey[] $singleRegionKeys
         */
        public function setSingleRegionKeys($singleRegionKeys)
        {
        }
        /**
         * @return GoogleCloudDiscoveryengineV1alphaSingleRegionKey[]
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1alphaCmekConfig registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaCmekConfig extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1alphaCmekConfig
    {
    }
}