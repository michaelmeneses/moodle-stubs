...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec extends \Google\Collection
    {
        /**
        ...
        protected $controlPointsType = GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpecControlPoint::class;
         ...
         *
         * @param GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpecControlPoint[] $controlPoints
         */
        public function setControlPoints($controlPoints)
        {
        }
        /**
         * @return GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpecControlPoint[]
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec
    {
    }
}