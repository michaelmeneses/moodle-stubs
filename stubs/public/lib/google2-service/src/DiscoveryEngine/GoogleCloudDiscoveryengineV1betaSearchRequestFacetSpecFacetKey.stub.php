...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudDiscoveryengineV1betaInterval[] $intervals
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey
    {
    }
}