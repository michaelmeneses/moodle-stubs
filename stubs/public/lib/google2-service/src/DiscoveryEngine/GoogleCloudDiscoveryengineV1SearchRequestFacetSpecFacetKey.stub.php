...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/DiscoveryEngine/GoogleCloudDiscoveryengineV1SearchRequestFacetSpecFacetKey.php
 *
...
namespace Google\Service\DiscoveryEngine {
    class GoogleCloudDiscoveryengineV1SearchRequestFacetSpecFacetKey extends \Google\Collection
    {
         ...
         *
         * @param GoogleCloudDiscoveryengineV1Interval[] $intervals
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1SearchRequestFacetSpecFacetKey registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1SearchRequestFacetSpecFacetKey extends \Google\Service\DiscoveryEngine\GoogleCloudDiscoveryengineV1SearchRequestFacetSpecFacetKey
    {
    }
}