...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Contactcenterinsights/GoogleCloudContactcenterinsightsV1IssueModel.php
 *
...
namespace Google\Service\Contactcenterinsights {
    class GoogleCloudContactcenterinsightsV1IssueModel extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudContactcenterinsightsV1IssueModelInputDataConfig $inputDataConfig
         */
         ...
         * data.
         *
         * @param GoogleCloudContactcenterinsightsV1IssueModelLabelStats $trainingStats
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Contactcenterinsights\GoogleCloudContactcenterinsightsV1IssueModel registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1IssueModel extends \Google\Service\Contactcenterinsights\GoogleCloudContactcenterinsightsV1IssueModel
    {
    }
}