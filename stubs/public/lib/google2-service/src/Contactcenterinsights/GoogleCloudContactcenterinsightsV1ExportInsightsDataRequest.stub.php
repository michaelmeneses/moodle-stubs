...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/Contactcenterinsights/GoogleCloudContactcenterinsightsV1ExportInsightsDataRequest.php
 *
...
namespace Google\Service\Contactcenterinsights {
    class GoogleCloudContactcenterinsightsV1ExportInsightsDataRequest extends \Google\Model
    {
         ...
         *
         * @param GoogleCloudContactcenterinsightsV1ExportInsightsDataRequestBigQueryDestination $bigQueryDestination
         */
...
namespace {
    /**
     * Runtime class alias of \Google\Service\Contactcenterinsights\GoogleCloudContactcenterinsightsV1ExportInsightsDataRequest registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1ExportInsightsDataRequest extends \Google\Service\Contactcenterinsights\GoogleCloudContactcenterinsightsV1ExportInsightsDataRequest
    {
    }
}