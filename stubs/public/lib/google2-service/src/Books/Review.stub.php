...
namespace {
    /**
     * Runtime class alias of \Google\Service\Books\Review registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Books_Review extends \Google\Service\Books\Review
    {
    }
}