...
namespace {
    /**
     * Runtime class alias of \Google\Service\DLP\GooglePrivacyDlpV2Action registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_DLP_GooglePrivacyDlpV2Action extends \Google\Service\DLP\GooglePrivacyDlpV2Action
    {
    }
}