...
namespace {
    /**
     * Runtime class alias of \Google\Service\VersionHistory\Release registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_VersionHistory_Release extends \Google\Service\VersionHistory\Release
    {
    }
}