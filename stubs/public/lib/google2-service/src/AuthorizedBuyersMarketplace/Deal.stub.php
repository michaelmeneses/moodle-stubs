...
namespace {
    /**
     * Runtime class alias of \Google\Service\AuthorizedBuyersMarketplace\Deal registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_AuthorizedBuyersMarketplace_Deal extends \Google\Service\AuthorizedBuyersMarketplace\Deal
    {
    }
}