...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/OSConfig/Resource/FoldersLocationsOsconfigGlobalPolicyOrchestrators.php
 *
...
namespace Google\Service\OSConfig\Resource {
     ...
     *   $policyOrchestrators = $osconfigService->folders_locations_global_policyOrchestrators;
     *  </code>
     */
    class FoldersLocationsOsconfigGlobalPolicyOrchestrators extends \Google\Service\Resource
    {
        /**
         ...
         * (policyOrchestrators.listFoldersLocationsOsconfigGlobalPolicyOrchestrators)
         *
         ...
         * @throws \Google\Service\Exception
         */
        public function listFoldersLocationsOsconfigGlobalPolicyOrchestrators($parent, $optParams = [])
        {
        }
        /**
...
namespace {
    /**
     * Runtime class alias of \Google\Service\OSConfig\Resource\FoldersLocationsOsconfigGlobalPolicyOrchestrators registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_OSConfig_Resource_FoldersLocationsOsconfigGlobalPolicyOrchestrators extends \Google\Service\OSConfig\Resource\FoldersLocationsOsconfigGlobalPolicyOrchestrators
    {
    }
}