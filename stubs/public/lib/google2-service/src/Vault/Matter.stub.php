...
namespace {
    /**
     * Runtime class alias of \Google\Service\Vault\Matter registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Vault_Matter extends \Google\Service\Vault\Matter
    {
    }
}