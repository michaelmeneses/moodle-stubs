...
/**
 * Auto-generated stub file for Moodle's public/lib/google2-service/src/CloudLocationFinder/SearchCloudLocationsResponse.php
 *
...
namespace Google\Service\CloudLocationFinder {
    class SearchCloudLocationsResponse extends \Google\Collection
    {
...
namespace {
    /**
     * Runtime class alias of \Google\Service\CloudLocationFinder\SearchCloudLocationsResponse registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_CloudLocationFinder_SearchCloudLocationsResponse extends \Google\Service\CloudLocationFinder\SearchCloudLocationsResponse
    {
    }
}