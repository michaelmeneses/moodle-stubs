...
namespace {
    /**
     * Runtime class alias of \Google\Service\OnDemandScanning\InTotoSlsaProvenanceV1 registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_OnDemandScanning_InTotoSlsaProvenanceV1 extends \Google\Service\OnDemandScanning\InTotoSlsaProvenanceV1
    {
    }
}