...
namespace {
    /**
     * Runtime class alias of \Google\Service\OnDemandScanning\CVSS registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_OnDemandScanning_CVSS extends \Google\Service\OnDemandScanning\CVSS
    {
    }
}