...
namespace {
    /**
     * Runtime class alias of \Google\Service\OnDemandScanning\UpgradeOccurrence registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_OnDemandScanning_UpgradeOccurrence extends \Google\Service\OnDemandScanning\UpgradeOccurrence
    {
    }
}