...
namespace {
    /**
     * Runtime class alias of \Google\Service\OnDemandScanning\BinarySourceInfo registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_OnDemandScanning_BinarySourceInfo extends \Google\Service\OnDemandScanning\BinarySourceInfo
    {
    }
}