...
namespace {
    /**
     * Runtime class alias of \Google\Service\BinaryAuthorization\Check registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_BinaryAuthorization_Check extends \Google\Service\BinaryAuthorization\Check
    {
    }
}