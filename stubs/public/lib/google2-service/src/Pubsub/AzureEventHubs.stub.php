...
namespace {
    /**
     * Runtime class alias of \Google\Service\Pubsub\AzureEventHubs registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Pubsub_AzureEventHubs extends \Google\Service\Pubsub\AzureEventHubs
    {
    }
}