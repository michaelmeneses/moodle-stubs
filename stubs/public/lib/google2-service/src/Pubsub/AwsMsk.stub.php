...
namespace {
    /**
     * Runtime class alias of \Google\Service\Pubsub\AwsMsk registered by the original source,
     * re-emitted as a declaration so static analysers can resolve the name.
     */
    class Google_Service_Pubsub_AwsMsk extends \Google\Service\Pubsub\AwsMsk
    {
    }
}