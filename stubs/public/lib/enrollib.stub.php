...
/**
 * Auto-generated stub file for Moodle's public/lib/enrollib.php
 *
 ...
 * @return array
 */
function enrol_get_my_courses($fields = null, $sort = null, $limit = 0, $courseids = [], $allaccessible = false, $offset = 0, $excludecourses = [])
{
}
/**
 ...
 */
function get_enrolled_with_capabilities_join(context $context, $prefix = '', $capability = '', $groupids = 0, $onlyactive = false, $onlysuspended = false, $enrolid = 0)
{
}
/**
 ...
 */
function get_enrolled_sql(context $context, $withcapability = '', $groupids = 0, $onlyactive = false, $onlysuspended = false, $enrolid = 0)
{
}
/**
 ...
 */
function get_enrolled_users(context $context, $withcapability = '', $groupids = 0, $userfields = 'u.*', $orderby = null, $limitfrom = 0, $limitnum = 0, $onlyactive = false)
{
}
/**
...
abstract class enrol_plugin
{
     ...
     */
    public function send_course_welcome_message_to_user(stdClass $instance, int $userid, int $sendoption, ?string $message = '', ?int $roleid = null): void
    {
    }
    /**
