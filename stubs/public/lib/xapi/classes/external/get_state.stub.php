...
/**
 * Auto-generated stub file for Moodle's public/lib/xapi/classes/external/get_state.php
 *
...
class get_state extends external_api
{
     ...
     * @return string|null
     */
    public static function execute(string $component, string $activityiri, string $agent, string $stateid, ?string $registration = null): ?string
    {
    }
    /**
     * Return for execute.
