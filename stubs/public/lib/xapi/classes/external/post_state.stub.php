...
/**
 * Auto-generated stub file for Moodle's public/lib/xapi/classes/external/post_state.php
 *
...
class post_state extends external_api
{
     ...
     * @return bool
     */
    public static function execute(string $component, string $activityiri, string $agent, string $stateid, string $statedata, ?string $registration = null): bool
    {
    }
    /**
     * Return for execute.
