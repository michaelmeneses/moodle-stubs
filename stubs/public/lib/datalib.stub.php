...
/**
 * Auto-generated stub file for Moodle's public/lib/datalib.php
 *
 ...
 */
function users_search_sql(string $search, string $u = 'u', int $searchtype = USER_SEARCH_STARTS_WITH, array $extrafields = [], ?array $exclude = null, ?array $includeonly = null): array
{
}
/**
 ...
 */
function print_object($item, array $expandclasses = ['/./'], bool $textonly = false, bool $return = false, int $depth = 0, array $done = []): string
{
}
/**
