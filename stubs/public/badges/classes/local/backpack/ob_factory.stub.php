...
/**
 * Auto-generated stub file for Moodle's public/badges/classes/local/backpack/ob_factory.php
 *
...
abstract class ob_factory
{
     ...
     */
    public static function create_assertion_exporter_from_hash(string $hash, string $apiversion): assertion_exporter_interface
    {
    }
    /**
     ...
     */
    public static function create_badge_exporter_from_id(int $badgeid, string $apiversion): badge_exporter_interface
    {
    }
    /**
     ...
     * @return \core_badges\local\backpack\ob\badge_exporter_interface The badge exporter object.
     */
    public static function create_badge_exporter_from_hash(string $hash, string $apiversion): badge_exporter_interface
    {
    }
    /**
     ...
     */
    public static function create_issuer_exporter_from_id(?int $badgeid, string $apiversion): issuer_exporter_interface
    {
    }
}