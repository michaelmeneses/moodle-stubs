...
/**
 * Auto-generated stub file for Moodle's public/calendar/externallib.php
 *
...
class core_calendar_external extends external_api
{
     ...
     * @return array
     */
    public static function get_calendar_action_events_by_timesort($timesortfrom = 0, $timesortto = null, $aftereventid = 0, $limitnum = 20, $limittononsuspendedevents = false, $userid = null, ?string $searchvalue = null)
    {
    }
    /**
     * Returns description of method result value.
     ...
     * @return array
     */
    public static function get_calendar_action_events_by_course($courseid, $timesortfrom = null, $timesortto = null, $aftereventid = 0, $limitnum = 20, ?string $searchvalue = null)
    {
    }
    /**
     * Returns description of method result value.
     ...
     * @return array
     */
    public static function get_calendar_action_events_by_courses(array $courseids, $timesortfrom = null, $timesortto = null, $limitnum = 10, ?string $searchvalue = null)
    {
    }
    /**
     * Returns description of method result value.
     ...
     * @return  array
     */
    public static function get_calendar_monthly_view($year, $month, $courseid, $categoryid, $includenavigation, $mini, $day, ?string $view = null)
    {
    }
    /**
     * Returns description of method parameters.
