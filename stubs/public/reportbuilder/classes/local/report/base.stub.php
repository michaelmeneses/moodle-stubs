...
abstract class base
{
     ...
     */
    final protected function add_columns_from_entity(string|entity_base $entityname, array $include = [], array $exclude = []): void
    {
    }
    /**
     ...
     * @throws coding_exception If both $include and $exclude are non-empty
     */
    final protected function add_filters_from_entity(string|entity_base $entityname, array $include = [], array $exclude = []): void
    {
    }
    /**
