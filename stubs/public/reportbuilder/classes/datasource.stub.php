...
abstract class datasource extends base
{
     ...
     */
    final protected function add_conditions_from_entity(string|entity_base $entityname, array $include = [], array $exclude = []): void
    {
    }
    /**
     ...
     */
    final protected function add_all_from_entity(string|entity_base $entityname, array $limitcolumns = [], array $limitfilters = [], array $limitconditions = []): void
    {
    }
    /**
