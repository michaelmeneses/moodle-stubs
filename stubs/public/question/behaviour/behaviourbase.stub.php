...
/**
 * Auto-generated stub file for Moodle's public/question/behaviour/behaviourbase.php
 *
...
abstract class question_behaviour
{
     ...
     */
    public function render(question_display_options $options, $number, core_question_renderer $qoutput, qtype_renderer $qtoutput)
    {
    }
    /**
...
abstract class question_cbm
{
    ...
    protected static $rightscore = array(self::LOW => 1, self::MED => 2, self::HIGH => 3);
    protected static $wrongscore = array(self::LOW => 0, self::MED => -2, self::HIGH => -6);
    /**#@-*/
    /**#@+ @var array upper and lower limits of the optimal window. */
    protected static $lowlimit = array(self::LOW => 0, self::MED => 0.666666666666667, self::HIGH => 0.8);
    protected static $highlimit = array(self::LOW => 0.666666666666667, self::MED => 0.8, self::HIGH => 1);
    /**#@-*/
    /**
