...
/**
 * Auto-generated stub file for Moodle's public/question/bank/managecategories/classes/question_category_list.php
 *
...
class question_category_list extends moodle_list
{
     ...
     * @todo Final removal in Moodle 6.0 MDL-80804
     */
    public function __construct($type = 'ul', $attributes = '', $editable = false, $pageurl = null, $page = 0, $pageparamname = 'page', $itemsperpage = DEFAULT_QUESTIONS_PER_PAGE, $context = null)
    {
    }
    /**
