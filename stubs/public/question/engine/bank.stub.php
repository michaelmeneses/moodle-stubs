...
/**
 * Auto-generated stub file for Moodle's public/question/engine/bank.php
 *
...
class question_finder implements data_source_interface
{
    ...
    public function get_questions_from_categories_with_usage_counts($categoryids, qubaid_condition $qubaids, $extraconditions = '', $extraparams = [])
    {
    }
    /**
     * @deprecated since Moodle 4.3
     */
    #[\core\attribute\deprecated(null, since: '4.3', mdl: 'MDL-72321', final: true)]
    public function get_questions_from_categories_and_tags_with_usage_counts($categoryids, qubaid_condition $qubaids, $extraconditions = '', $extraparams = [], $tagids = [])
    {
    }
    #[\Override]
