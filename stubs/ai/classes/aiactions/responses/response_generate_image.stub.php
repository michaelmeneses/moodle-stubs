...
/**
 * Auto-generated stub file for Moodle's ai/classes/aiactions/responses/response_generate_image.php
 *
...
class response_generate_image extends response_base
{
     ...
     */
    public function __construct(bool $success, int $errorcode = 0, string $errormessage = '')
    {
    }
    #[\Override]
