...
class course_enrolment_table extends html_table implements renderable
{
     ...
     * @var array
     */
    protected static $sortablefields = array('firstname', 'lastname', 'firstnamephonetic', 'lastnamephonetic', 'middlename', 'alternatename', 'idnumber', 'email', 'phone1', 'phone2', 'institution', 'department');
    /**
...
class course_enrolment_users_table extends course_enrolment_table
{
     ...
     * @var array
     */
    protected static $sortablefields = array('firstname', 'lastname', 'firstnamephonetic', 'lastnamephonetic', 'middlename', 'alternatename', 'email', 'lastaccess');
}
/**
