...
class Horde_Mime_Part implements ArrayAccess, Countable, Serializable
{
     ...
     * @var array
     */
    protected $_serializedVars = array('_type', '_subtype', '_transferEncoding', '_language', '_description', '_disposition', '_dispParams', '_contentTypeParams', '_parts', '_mimeid', '_eol', '_metadata', '_boundary', '_bytes', '_contentid', '_duration', '_reindex', '_basepart', '_hdrCharset');
    /**
     * Constructor.
     */
