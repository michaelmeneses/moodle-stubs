...
/**
 * Auto-generated stub file for Moodle's lib/phpspreadsheet/phpspreadsheet/src/PhpSpreadsheet/Calculation/Financial.php
 *
...
class Financial
{
     ...
     */
    public static function ACCRINT($issue, $firstInterest, $settlement, $rate, $parValue = 1000, $frequency = 1, $basis = 0, $calcMethod = true)
    {
    }
    /**
     * ACCRINTM.
