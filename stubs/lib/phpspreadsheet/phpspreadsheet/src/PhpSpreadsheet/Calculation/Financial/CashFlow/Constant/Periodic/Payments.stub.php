...
class Payments
{
     ...
     */
    public static function annuity($interestRate, $numberOfPeriods, $presentValue, $futureValue = 0, $type = FinancialConstants::PAYMENT_END_OF_PERIOD)
    {
    }
    /**
     * PPMT.
     ...
     * @return float|string Result, or a string containing an error
     */
    public static function interestPayment($interestRate, $period, $numberOfPeriods, $presentValue, $futureValue = 0, $type = FinancialConstants::PAYMENT_END_OF_PERIOD)
    {
    }
}