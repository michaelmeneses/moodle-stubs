...
class Calculation
{
     ...
     */
    private static $localeBoolean = ['TRUE' => 'TRUE', 'FALSE' => 'FALSE', 'NULL' => 'NULL'];
     ...
     * @var array
     */
    private static $controlFunctions = ['MKMATRIX' => ['argumentCount' => '*', 'functionCall' => [Internal\MakeMatrix::class, 'make']], 'NAME.ERROR' => ['argumentCount' => '*', 'functionCall' => [Functions::class, 'NAME']], 'WILDCARDMATCH' => ['argumentCount' => '2', 'functionCall' => [Internal\WildcardMatch::class, 'compare']]];
