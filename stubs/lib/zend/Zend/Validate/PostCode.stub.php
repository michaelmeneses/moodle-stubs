...
class Zend_Validate_PostCode extends Zend_Validate_Abstract
{
     ...
     * @var array
     */
    protected $_messageTemplates = array(self::INVALID => "Invalid type given. The value should be a string or a integer", self::NO_MATCH => "'%value%' does not appear to be a postal code");
    /**
     * Locale to use
     *
     * @var string
