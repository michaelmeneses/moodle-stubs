...
class Compiler
{
    ...
    // mix two colors
    protected static $libMix = [['color1', 'color2', 'weight:0.5'], ['color-1', 'color-2', 'weight:0.5']];
    ...
    protected static $libHsla = [['channels'], ['hue', 'saturation', 'lightness'], ['hue', 'saturation', 'lightness', 'alpha']];
    ...
    protected static $libMapMerge = [['map1', 'map2'], ['map-1', 'map-2']];
