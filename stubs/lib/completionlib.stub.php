...
class completion_info
{
     ...
     * @return  array
     */
    function get_tracked_users($where = '', $where_params = array(), $groupid = 0, $sort = '', $limitfrom = '', $limitnum = '')
    {
    }
    /**
     ...
     */
    public function get_progress_all($where = '', $where_params = array(), $groupid = 0, $sort = '', $pagesize = '', $start = '')
    {
    }
    /**
