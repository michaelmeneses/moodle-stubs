...
final class SharedStringsManager
{
    ...
    public function __construct(string $filePath, Options $options, WorkbookRelationshipsManager $workbookRelationshipsManager, CachingStrategyFactory $cachingStrategyFactory)
    {
    }
    /**
