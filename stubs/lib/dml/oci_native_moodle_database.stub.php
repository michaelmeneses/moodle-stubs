...
class oci_native_moodle_database extends moodle_database
{
    ...
    // To store stmt errors and enable get_last_error() to detect them
    private $commit_status = null;
    // default value initialised in connect method, we need the driver to be present
    private $last_error_reporting;
    // To handle oci driver default verbosity
    private $unique_session_id;
    // To store unique_session_id. Needed for temp tables unique naming
    private $dblocks_supported = null;
    // To cache locks support along the connection life
    private $bitwise_supported = null;
    // To cache bitwise operations support along the connection life
    /**
