...
/**
 * Auto-generated stub file for Moodle's lib/giggsey/libphonenumber-for-php-lite/src/PhoneNumberUtil.php
 *
...
class PhoneNumberUtil
{
     ...
     */
    public static function getInstance(string $baseFileLocation = self::META_DATA_FILE_PREFIX, ?array $countryCallingCodeToRegionCodeMap = null, ?MetadataLoaderInterface $metadataLoader = null, ?MetadataSourceInterface $metadataSource = null): PhoneNumberUtil
    {
    }
     ...
     * @param int $numberFormat PhoneNumberFormat
     */
    public function formatNsnUsingPattern(string $nationalNumber, NumberFormat $formattingPattern, int $numberFormat, ?string $carrierCode = null): string
    {
    }
    /**
