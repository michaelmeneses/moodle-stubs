...
class moodlenet_client
{
     ...
     */
    protected function prepare_file_share_request_data(string $filename, string $mimetype, StreamInterface $stream, string $resourcename, $resourcedescription): array
    {
    }
}