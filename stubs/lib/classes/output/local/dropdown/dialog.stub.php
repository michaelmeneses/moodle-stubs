...
/**
 * Auto-generated stub file for Moodle's lib/classes/output/local/dropdown/dialog.php
 *
...
class dialog implements named_templatable, renderable
{
    ...
    public const POSITION = ['start' => 'dropdown-menu-left', 'end' => 'dropdown-menu-right'];
    /** Dropdown dialog positions. */
