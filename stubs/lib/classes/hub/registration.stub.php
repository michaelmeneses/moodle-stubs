...
class registration
{
    ...
    const FORM_FIELDS = ['name', 'description', 'contactname', 'contactemail', 'contactphone', 'imageurl', 'privacy', 'street', 'regioncode', 'countrycode', 'geolocation', 'contactable', 'emailalert', 'emailalertemail', 'commnews', 'commnewsemail', 'language', 'policyagreed'];
     ...
     */
    const CONFIRM_NEW_FIELDS = [2017092200 => [
        'commnews',
