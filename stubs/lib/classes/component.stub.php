...
class core_component
{
    ...
    protected static $psr0namespaces = array('Horde' => 'lib/horde/framework/Horde', 'Mustache' => 'lib/mustache/src/Mustache');
    /** @var array associative array of PRS-4 namespaces and corresponding paths. */
    protected static $psr4namespaces = array('MaxMind' => 'lib/maxmind/MaxMind', 'GeoIp2' => 'lib/maxmind/GeoIp2', 'Sabberworm\CSS' => 'lib/php-css-parser', 'MoodleHQ\RTLCSS' => 'lib/rtlcss', 'Leafo\ScssPhp' => 'lib/scssphp', 'Box\Spout' => 'lib/spout/src/Spout', 'MatthiasMullie\Minify' => 'lib/minify/matthiasmullie-minify/src/', 'MatthiasMullie\PathConverter' => 'lib/minify/matthiasmullie-pathconverter/src/', 'IMSGlobal\LTI' => 'lib/ltiprovider/src', 'Phpml' => 'lib/mlbackend/php/phpml/src/Phpml', 'PHPMailer\PHPMailer' => 'lib/phpmailer/src', 'RedeyeVentures\GeoPattern' => 'lib/geopattern-php/GeoPattern', 'MongoDB' => 'cache/stores/mongodb/MongoDB', 'Firebase\JWT' => 'lib/php-jwt/src');
    /**
