...
class message
{
    ...
    private $properties = array('courseid', 'modulename', 'component', 'name', 'userfrom', 'convid', 'userto', 'subject', 'fullmessage', 'fullmessageformat', 'fullmessagehtml', 'smallmessage', 'notification', 'contexturl', 'contexturlname', 'replyto', 'replytoname', 'savedmessageid', 'attachment', 'attachname', 'timecreated');
