...
/**
 * Auto-generated stub file for Moodle's local/qeupgradehelper/locallib.php
 *
...
function local_qeupgradehelper_display_convert_attempt_input($quiz, $attempt, $question, $qsession, $qstates)
{
}
