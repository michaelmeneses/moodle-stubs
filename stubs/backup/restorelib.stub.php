...
class moodle_splitter_parser
{
    ...
    var $cdata = '';
    /// Raw storage for character data
    var $content = '';
    /// Content buffer to be printed to file
    var $trailing = '';
    /// Content of the trailing tree for each splited file
    var $savepath = null;
    /// Path to store splited files
    var $fhandler = null;
    /// Current file we are writing to
    var $tosplit = array();
    /// Array defining the files we want to split, in this format:
    /// array( level/tag/level/tag => filename)
    var $splitwords = array();
    /// Denormalised array containing the potential tags
    /// being a split point. To speed up check_split_point()
    var $maxsplitlevel = 0;
    /// Precalculated max level where any split happens. To speed up check_split_point()
    var $buffersize = 65536;
    /// 64KB is a good write buffer. Don't expect big benefits by increasing this.
    var $repectformat = false;
    /// With this setting enabled, the splited files will look like the original one
