...
class mock_simplified_parser_processor extends simplified_parser_processor
{
    ...
    // To accumulate all the notified path starts
    private $endarr = array();
    // To accumulate all the notified path ends
    private $allnotif = array();
    // To accumulate all the notified and dispatched events in an ordered way
