...
abstract class restore_dbops
{
     ...
     */
    public static function load_inforef_to_tempids($restoreid, $inforeffile, core_backup_progress $progress = null)
    {
    }
    /**
     ...
     * @param core_backup_progress $progress Progress tracker
     */
    public static function load_users_to_tempids($restoreid, $usersfile, core_backup_progress $progress = null)
    {
    }
    /**
     ...
     */
    public static function send_files_to_pool($basepath, $restoreid, $component, $filearea, $oldcontextid, $dfltuserid, $itemname = null, $olditemid = null, $forcenewcontextid = null, $skipparentitemidctxmatch = false, core_backup_progress $progress = null)
    {
    }
    /**
     ...
     */
    public static function create_included_users($basepath, $restoreid, $userid, core_backup_progress $progress)
    {
    }
    /**
     ...
     */
    public static function precheck_included_users($restoreid, $courseid, $userid, $samesite, core_backup_progress $progress)
    {
    }
    /**
     ...
     */
    public static function process_included_users($restoreid, $courseid, $userid, $samesite, core_backup_progress $progress = null)
    {
    }
    /**
