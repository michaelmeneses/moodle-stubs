...
abstract class backup_helper
{
     ...
     */
    public static function clear_backup_dir($backupid)
    {
    }
    /**
     * Given one backupid, delete completely its temp dir
     */
    public static function delete_backup_dir($backupid)
    {
    }
    /**
     ...
     * TODO: Modernise this
     */
    public static function delete_dir_contents($dir, $excludeddir = '')
    {
    }
    /**
     * Delete all the temp dirs older than the time specified
     */
    public static function delete_old_backup_dirs($deletefrom)
    {
    }
    /**
