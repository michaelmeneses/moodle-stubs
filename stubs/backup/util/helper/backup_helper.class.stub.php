...
abstract class backup_helper
{
     ...
     */
    public static function clear_backup_dir($backupid, core_backup_progress $progress = null)
    {
    }
    /**
     ...
     * @param core_backup_progress $progress Optional progress reporting object
     */
    public static function delete_backup_dir($backupid, core_backup_progress $progress = null)
    {
    }
    /**
     ...
     * @param core_backup_progress $progress Optional progress reporting object
     */
    public static function delete_dir_contents($dir, $excludeddir = '', core_backup_progress $progress = null)
    {
    }
    /**
     ...
     * @param core_backup_progress $progress Optional progress reporting object
     */
    public static function delete_old_backup_dirs($deletefrom, core_backup_progress $progress = null)
    {
    }
    /**
     ...
     */
    public static function store_backup_file($backupid, $filepath, core_backup_progress $progress = null)
    {
    }
    /**
