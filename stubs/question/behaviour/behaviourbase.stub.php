...
abstract class question_cbm
{
    ...
    protected static $factor = array(self::LOW => 0.333333333333333, self::MED => 1.333333333333333, self::HIGH => 3);
    protected static $offset = array(self::LOW => 0, self::MED => -0.666666666666667, self::HIGH => -2);
    /**#@-*/
    /**
