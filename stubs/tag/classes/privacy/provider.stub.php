 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements \core_privacy\local\metadata\provider, \core_privacy\local\request\subsystem\plugin_provider, \core_privacy\local\request\plugin\provider
{
    /**
     ...
     */
    public static function export_item_tags($userid, \context $context, array $subcontext, $component, $itemtype, $itemid, $onlyuser = false)
    {
    }
    /**
